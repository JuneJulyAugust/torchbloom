...
Problem 11.5* The forward pass for batch normalization given a batch of scalar values $\lbrace z_{i}\rbrace_{i=1}^{I}$ consists of the following operations (figure 11.15):
