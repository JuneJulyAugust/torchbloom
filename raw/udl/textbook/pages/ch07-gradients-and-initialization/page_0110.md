...
<p align="center">
  <img src="../../figures/page_0110_fig_1.jpg" alt="Figure 7.7 Weight initialization. Consider a deep network with 50 hidden layers and $D_{h}=100$ hidden units per layer. The network has a 100-dimensional input " />
</p>
