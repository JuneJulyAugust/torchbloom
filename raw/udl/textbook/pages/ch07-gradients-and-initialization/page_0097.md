...
$$
\begin{aligned}
\phi_{t+1}\longleftarrow\phi_{t}-\alpha\sum_{i\in\mathcal{B}_{t}}\frac{\partial\ell_{i}[\phi_{t}]}{\partial\phi}, \tag{7.3}
\end{aligned}
$$
...
$$
\begin{aligned}
\frac{\partial\ell_{i}}{\partial\beta_{k}}\qquad and\qquad\frac{\partial\ell_{i}}{\partial\Omega_{k}}, \tag{7.4}
\end{aligned}
$$
