...
$$
\begin{aligned}
\frac{\partial f_{0}}{\partial\beta_{0}}=1\qquad and\quad\frac{\partial f_{0}}{\partial\omega_{0}}\quad=\quad x_{i}.
\end{aligned}
\tag{7.16}
$$
...
$$
\begin{aligned}
\begin{array}{rcl}\mathbf{f}_{0}&=&\beta_{0}+\Omega_{0}x_{i}\\ \mathbf{h}_{1}&=&a[\mathbf{f}_{0}]\\ \mathbf{f}_{1}&=&\beta_{1}+\Omega_{1}\mathbf{h}_{1}\\ \mathbf{f}_{2}&=&a[\mathbf{f}_{0}]\\\beta_{3}&=&\beta_{1}+\Omega_{2}\mathbf{h}_{2}\\ \mathbf{f}_{3}&=&a[\mathbf{f}_{0}]\\\beta_{4}&=&\beta_{2}+\Omega_{3}\mathbf{h}_{3}\\ \ell_{i}&=&l[\mathbf{f}_{0},y_{i}],\end{array}
\end{aligned}
\tag{7.17}
$$
