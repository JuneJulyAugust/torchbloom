...
$$
\begin{aligned}
\frac{\partial y}{\partial f_{5}},\frac{\partial y}{\partial f_{4}},\frac{\partial y}{\partial f_{3}},\frac{\partial y}{\partial f_{2}},\frac{\partial y}{\partial f_{1}}\mathrm{a n d}\frac{\partial y}{\partial x}, \tag{7.45}
\end{aligned}
$$
...
$$
\begin{aligned}
\frac{\partial f_{1}}{\partial x},\frac{\partial f_{2}}{\partial x},\frac{\partial f_{3}}{\partial x},\frac{\partial f_{4}}{\partial x},\frac{\partial f_{5}}{\partial x},and\frac{\partial y}{\partial x}, \tag{7.46}
\end{aligned}
$$
...
$$
\begin{aligned}
b=\mathrm{ReLU}[a]=\begin{cases}0&a<0\\ a&a\geq0\end{cases}, \tag{7.47}
\end{aligned}
$$
