...
$$
\begin{aligned}
\begin{array}{rcl}h_{1}^{\prime}&=&a[\theta_{10}^{\prime}+\theta_{11}^{\prime}y]\\h_{2}^{\prime}&=&a[\theta_{20}^{\prime}+\theta_{21}^{\prime}y]\\h_{3}^{\prime}&=&a[\theta_{30}^{\prime}+\theta_{31}^{\prime}y],\end{array} \tag{4.3}
\end{aligned}
$$
...
The output of the first network ( $y = \phi_{0} + \phi_{1}h_{1} + \phi_{2}h_{2} + \phi_{3}h_{3}$ ) is a linear combination of the activations at the hidden units. The first operations of the second network (equation 4.3 in which we calculate  $\theta_{10}^{\prime} + \theta_{11}^{\prime}y$ ,  $\theta_{20}^{\prime} + \theta_{21}^{\prime}y$ , and  $\theta_{30}^{\prime} + \theta_{31}^{\prime}y$ ) are linear in the output of the first network. Applying one linear function to another yields another linear function. Substituting the expression for y into equation 4.3 gives:

$$
\begin{aligned}
\begin{array}{rcl}h_{1}^{\prime}&=&a[\theta_{10}^{\prime}+\theta_{11}^{\prime}y]=&a[\theta_{10}^{\prime}+\theta_{11}^{\prime}\phi_{0}+\theta_{11}^{\prime}\phi_{1}h_{1}+\theta_{11}^{\prime}\phi_{2}h_{2}+\theta_{11}^{\prime}\phi_{3}h_{3}]\\h_{2}^{\prime}&=&a[\theta_{20}^{\prime}+\theta_{21}^{\prime}y]=&a[\theta_{20}^{\prime}+\theta_{21}^{\prime}\phi_{0}+\theta_{21}^{\prime}\phi_{1}h_{1}+\theta_{21}^{\prime}\phi_{2}h_{2}+\theta_{21}^{\prime}\phi_{3}h_{3}]\\h_{3}^{\prime}&=&a[\theta_{30}^{\prime}+\theta_{31}^{\prime}y]=&a[\phi_{0}+h_{1}\phi_{0}+\theta_{11}^{\prime}h_{1}+\theta_{21}^{\prime}\phi_{2}h_{2}+\theta_{31}^{\prime}h_{3}]\end{array} \tag{4.5}
\end{aligned}
$$
...
$$
\begin{aligned}
\begin{array}{rcl}h_{1}^{\prime}&=&a[\psi_{10}+\psi_{11}h_{1}+\psi_{12}h_{2}+\psi_{13}h_{3}]\\h_{2}^{\prime}&=&a[\psi_{20}+\psi_{21}h_{1}+\psi_{22}h_{2}+\psi_{23}h_{3}]\\h_{3}^{\prime}&=&a[\psi_{30}+\psi_{31}h_{1}+\psi_{32}h_{2}+\psi_{33}h_{3}],\end{array} \tag{4.6}
\end{aligned}
$$
