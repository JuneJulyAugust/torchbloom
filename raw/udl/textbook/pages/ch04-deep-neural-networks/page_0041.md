...
$$
\begin{aligned}&h_{1}\quad=\quad\mathrm{a}[\theta_{10}+\theta_{11}x]\\&h_{2}\quad=\quad\mathrm{a}[\theta_{20}+\theta_{21}x]\\&h_{3}\quad=\quad\mathrm{a}[\theta_{30}+\theta_{31}x],\\ \end{aligned} \quad (4.1)
$$
