...
$$
\begin{aligned}
\mathrm{ReLU}\Big[\boldsymbol{\beta}_{1}+\lambda_{1}\cdot\boldsymbol{\Omega}_{1}\mathrm{ReLU}[\boldsymbol{\beta}_{0}+\lambda_{0}\cdot\boldsymbol{\Omega}_{0}\mathbf{x}]\Big]=\lambda_{0}\lambda_{1}\cdot\mathrm{ReLU}\left[\frac{1}{\lambda_{0}}\boldsymbol{\beta}_{0}+\mathbf{\Omega}_{0}\mathbf{x}\right], \tag{4.18}
\end{aligned}
$$
