...
---
<p align="center">
  <img src="../../figures/page_0051_fig_1.jpg" alt="Figure 4.7 The maximum number of linear regions for neural networks increases rapidly with the network depth. a) Network with $D_{i}=1$ input. Each curve repres" />
</p>
