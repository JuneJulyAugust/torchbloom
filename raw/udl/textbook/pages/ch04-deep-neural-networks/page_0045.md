...
$$
\begin{aligned}
\begin{array}{rcl}h_{1}&=&a[\theta_{10}+\theta_{11}x]\\h_{2}&=&a[\theta_{20}+\theta_{21}x]\\h_{3}&=&a[\psi_{30}+\psi_{31}h_{1}+\psi_{32}h_{2}+\psi_{33}h_{3}],\end{array} \tag{4.7}
\end{aligned}
$$
...
$$
\begin{aligned}
\begin{array}{rcl}h_{1}&=&a[\psi_{10}+\psi_{11}h_{1}+\psi_{12}h_{2}+\psi_{13}h_{3}]\\h_{2}&=&a[\psi_{20}+\psi_{21}h_{1}+\psi_{22}h_{2}+\psi_{23}h_{3}]\\h_{3}&=&a[\psi_{30}+\psi_{31}h_{1}+\psi_{32}h_{2}+\psi_{33}h_{3}],\end{array} \tag{4.8}
\end{aligned}
$$
