...
$$
\begin{array}{r l r}q(\mathbf{z}_{1}|\mathbf{x})&=&{\mathrm{Norm}_{\mathbf{z}_{1}}\left[\sqrt{1-\beta_{1}\mathbf{x}},\beta_{1}\mathbf{I}\right]}\\q(\mathbf{z}_{t}|\mathbf{z}_{t-1})&=&{\mathrm{Norm}_{\mathbf{z}_{t}}\left[\sqrt{1-\beta_{t}\mathbf{z}_{t-1}},\beta_{t}\mathbf{I}\right]}&{\quad\forall t\in\lbrace2,\ldots,T\rbrace.\end{array}
$$
