...
$$
\begin{aligned}
q(\mathbf{z}_{1}\,|\,\mathbf{x})&=\mathrm{Norm}_{\mathbf{z}_{1}}\left[\sqrt{1-\beta_{1}}\cdot\mathbf{x},\beta_{1}\mathbf{I}\right]\\
q(\mathbf{z}_{t}\,|\,\mathbf{z}_{t-1})&=\mathrm{Norm}_{\mathbf{z}_{t}}\left[\sqrt{1-\beta_{t}}\cdot\mathbf{z}_{t-1},\beta_{t}\mathbf{I}\right]\quad\forall t\in\lbrace 2,\ldots,T\rbrace.
\end{aligned}
\qquad (18.2)
$$
...
$$
q(\mathbf{z}_{1\ldots T}\,|\,\mathbf{x})=q(\mathbf{z}_{1}\,|\,\mathbf{x})\prod_{t=2}^{T}q(\mathbf{z}_{t}\,|\,\mathbf{z}_{t-1}).\qquad (18.3)
$$
