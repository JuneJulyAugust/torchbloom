...
---
<p align="center">
  <img src="../../figures/page_0369_fig_2.jpg" alt="Figure 18.12 Conditional generation using classifier guidance. Image samples conditioned on different ImageNet classes. The same model produces high quality samples of highly varie" />
</p>
...
<p align="center">
  <img src="../../figures/page_0369_fig_1.jpg" alt="Figure 18.13 Conditional generation using text prompts. Synthesized images from a cascaded generation framework, conditioned on a text prompt encoded by a large language model. The" />
</p>
