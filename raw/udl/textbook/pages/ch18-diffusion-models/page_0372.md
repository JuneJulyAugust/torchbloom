...
$$
\mathrm{Norm}_{\mathbf{v}}\left[\mathbf{A}\mathbf{w},\mathbf{B}\right]\propto\mathrm{Norm}_{\mathbf{w}}\left[\left(\mathbf{A}^{T}\mathbf{B}^{-1}\mathbf{A}\right)^{-1}\mathbf{A}^{T}\mathbf{B}^{-1}\mathbf{v},\left(\mathbf{A}^{T}\mathbf{E}^{\frac{3}{2}}\mathbf{B}^{-1}\right)^{-1}\right]. \quad (18.46)
$$
