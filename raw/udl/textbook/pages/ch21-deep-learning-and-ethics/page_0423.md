...
---
<p align="center">
  <img src="../../figures/page_0423_fig_1.jpg" alt="Figure 21.1 Structural description of the value alignment problem" />
</p>

<p align="center">
  <strong>Figure 21.1</strong> Structural description of the value alignment problem. Problems arise from a) misaligned objectives (e.g., bias) or b) informational asymmetries between a (human) principal and an (artificial) agent (e.g., lack of explainability). Adapted from LaCroix (2025).
</p>
