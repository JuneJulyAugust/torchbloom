...
---
<p align="center">
  <img src="../../figures/page_0095_fig_1.jpg" alt="Figure 6.11 Three 1D loss functions for problem 6.6." />
</p>
...
(i) Plot y against x for this model for different values of  $\phi_{0}$  and  $\phi_{1}$  and explain the qualitative meaning of each parameter. (ii) What is a suitable loss function for this model? (iii) Compute the derivatives of this loss function with respect to the parameters. (iv) Generate ten data points from a normal distribution with mean -1 and standard deviation 1 and assign them the label y = 0. Generate another ten data points from a normal distribution with mean 1 and standard deviation 1 and assign them the label y = 0. Generate another ten data points from a normal distribution with mean -1 and standard deviation 1 and assign them the label y = 0. Generate another ten data points from a normal distribution with mean -1 and standard deviation 1.
...
$$
\begin{aligned}
\mathrm{f}[x,\phi]=\phi_{0}+\phi_{1}\mathrm{a}[\theta_{10}+\theta_{11}x]+\phi_{2}\mathrm{a}[\theta_{20}+\theta_{21}x]+\phi_{3}\mathrm{a}[\theta_{30}+\theta_{31}x]. \tag{6.23}
\end{aligned}
$$
