...
---
<p align="center">
  <img src="../../figures/page_0084_fig_1.jpg" alt="Figure 6.6 Alternative view of SGD for the Gabor model with a batch size three. a) Loss function for the entire training dataset. At each iteration, there is a " />
</p>

<p align="center">
  <strong>Figure 6.6</strong> Alternative view of SGD for the Gabor model with a batch size three.
