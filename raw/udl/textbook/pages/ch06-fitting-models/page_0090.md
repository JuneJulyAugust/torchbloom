...
---
$$
\begin{aligned}\mathbf{m}_{t+1}&\leftarrow\quad\beta\cdot\mathbf{m}_{t}+(1-\beta)\frac{\partial L[\phi_{t}]}{\partial\phi}\\ \mathbf{v}_{t+1}&\leftarrow\quad\gamma\cdot\mathbf{v}_{t}+(1-\gamma)\left(\frac{\partial L[\phi_{t}]}{\partial\phi}\right)^{2},\end{aligned} \quad (6.15)
$$
...
$$
\begin{aligned}
\phi_{t+1}\quad\leftarrow\quad\phi_{t}-\alpha\cdot\frac{\tilde{\mathbf{m}}_{t+1}}{\sqrt{\tilde{\mathbf{v}}}_{t+1}+\epsilon}.
...
$$
\begin{aligned}\mathbf{m}_{t+1}&\leftarrow\quad\beta\cdot\mathbf{m}_{t}+(1-\beta)\sum_{i\in\mathcal{B}_{t}}\frac{\partial\ell_{i}[\phi_{t}]}{\partial\phi}\\ \mathbf{v}_{t+1}&\leftarrow\quad\gamma\cdot\mathbf{v}_{t}+(1-\gamma)\Bigg(\sum_{i\in\mathcal{B}_{t}}\frac{\partial\ell_{i}[\phi_{t}]}{\partial\phi}\Bigg)^{2},\end{aligned} \quad (6.18)
$$
