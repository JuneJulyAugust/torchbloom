...
**Problem 6.1** $$
\begin{aligned}
\frac{\partial\ell_{i}}{\partial\boldsymbol{\phi}}=\left[\begin{array}{c}\displaystyle\frac{\partial\ell_{i}}{\partial\phi_{0}}\\\displaystyle\frac{\partial\ell_{i}}{\partial\phi_{1}}\end{array}\right]=\left[\begin{array}{c}2(\phi_{0}+\phi_{1}x_{i}-y_{i})\\\displaystyle 2x_{i}(\phi_{0}+\phi_{1}x_{i}-y_{i})\end{array}\right]. \quad (6.7)
\end{aligned}
$$
...
$$
\begin{aligned}
\mathrm{f}[x,\boldsymbol{\phi}]=\sin[\phi_{0}+0.06\cdot\phi_{1}x]\cdot\exp\left(-\frac{(\phi_{0}+0.06\cdot\phi_{1}x)^{2}}{32.0}\right). \quad (6.8)
\end{aligned}
$$
...
$$
\begin{aligned}
L[\boldsymbol{\phi}]=\sum_{i=1}^{I}\left(\mathrm{f}[x_{i},\boldsymbol{\phi}]-y_{i}\right)^{2}. \quad (6.9)
\end{aligned}
$$
