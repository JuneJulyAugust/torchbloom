...
$$
\begin{aligned}
\frac{\partial L}{\partial\phi}=\begin{bmatrix}\displaystyle\frac{\partial L}{\partial\phi_{0}}\\ \displaystyle\frac{\partial L}{\partial\phi_{1}}\\ \vdots\\ \displaystyle\frac{\partial L}{\partial\phi_{N}}\end{bmatrix}. \tag{6.2}
\end{aligned}
$$
...
$$
\begin{aligned}y\quad&=\quad\mathbf{f}[x,\phi]\\&=\quad\phi_{0}+\phi_{1}x.\end{aligned} \tag{6.4}
$$
...
$$
\begin{aligned}
\begin{align*}L[\phi]\quad&=\quad\sum_{i=1}^{I}\ell_{i}\quad=\quad\sum_{i=1}^{I}(\mathbf{f}[x_{i},\phi]-y_{i})^{2}\\&=\quad\sum_{i=1}^{I}\left(\phi_{0}+\phi_{1}x_{i}-y_{i}\right)^{2},\end{align*} \tag{6.5}
\end{aligned}
$$
