...
$$
\mathbf{f}[\mathbf{x}]=\mathbf{R e L U}[\boldsymbol{\beta}+\Omega\mathbf{x}], \quad (12.1)
$$
...
$$
\mathbf{v}_{m}=\boldsymbol{\beta}_{v}+\Omega_{v}\mathbf{x}_{m}, \quad (12.2)
$$
...
$$
\mathbf{s a}_{n}[\mathbf{x}_{1},\ldots,\mathbf{x}_{N}]=\sum_{m=1}^{N}a[\mathbf{x}_{m},\mathbf{x}_{n}]\mathbf{v}_{m}. \quad (12.3)
$$
