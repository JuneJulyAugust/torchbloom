...
---
<p align="center">
  <img src="../../figures/page_0215_fig_1.jpg" alt="Figure 12.6 Multi-head self-attention. Self-attention occurs in parallel across multiple “heads.” Each has its own queri" />
</p>
...
$$
\mathbf{M h S a}[\mathbf{X}]=\Omega_{c}\left[\mathbf{S a}_{1}[\mathbf{X}]^{T},\mathbf{S a}_{2}[\mathbf{X}]^{T},\ldots,\mathbf{S a}_{H}[\mathbf{X}]^{T}\right]^{T}. \quad (12.12)
$$
