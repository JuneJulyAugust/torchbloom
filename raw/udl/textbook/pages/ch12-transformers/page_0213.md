...
---
<p align="center">
  <img src="../../figures/page_0213_fig_1.jpg" alt="Figure 12.5 Positional encodings. The self-attention architecture is equivariant to permutations of the inputs. To ensure that inputs at different positions are" />
</p>
...
$$
\mathbf{Sa}[\mathbf{X}]=\mathbf{V}\cdot\mathrm{softmax}\left[\mathbf{K}^{T}\mathbf{Q}\right]\qquad (12.8)
$$
