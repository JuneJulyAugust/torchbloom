...
<p align="center">
  <strong>Figure 12.14</strong> Cross-attention. The flow of computation is the same as in standard self-attention, but the queries are calculated from the decoder embeddings $X\_{dec}$ , and the keys and values from the encoder embeddings $X\_{enc}$ . For translation tasks, the encoder contains information about the source language statistics, and the decoder contains information about the target language statistics.
</p>
