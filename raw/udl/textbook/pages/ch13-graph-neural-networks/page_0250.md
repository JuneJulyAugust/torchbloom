...
---
<p align="center">
  <img src="../../figures/page_0250_fig_1.jpg" alt="Simple Graph CNN layer. a) Input graph consists of structure (embodied in graph adjacency matrix A, not shown)" />
</p>
...
$$
\begin{aligned}
\mathbf{a}\mathbf{g g}[n,k]=\sum_{m\in\mathbf{n e}[n]}\mathbf{h}_{k}^{(m)},
\end{aligned}
\tag{13.8}
$$
...
$$
\begin{aligned}
\mathbf{h}_{k+1}^{(n)}=\mathbf{a}\left[\boldsymbol{\beta}_{k}+\boldsymbol{\Omega_{k}}\cdot\mathbf{h}_{k}^{(n)}+\mathbf{\Omega_{k}}\cdot\mathbf{a}\mathbf{g g}[n,k]\right].
\end{aligned}
\tag{13.9}
$$
