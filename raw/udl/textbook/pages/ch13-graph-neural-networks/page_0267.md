...
---
<p align="center">
  <img src="../../figures/page_0267_fig_1.jpg" alt="Graphs for problems 13.1, 13.3, and 13.8." />
</p>
...
<p align="center">
  <img src="../../figures/page_0267_fig_2.jpg" alt="Graphs for problems 13.11–13.13." />
</p>
...
$$
\begin{aligned}\mathbf{H}_{k+1}&=\quad\mathbf{GraphLayer}[\mathbf{H}_{k},\mathbf{A}]\\&=\quad\mathbf{a}\left[\boldsymbol{\beta}_{k}\mathbf{1}^{T}+\boldsymbol{\Omega}_{k}\begin{bmatrix}\mathbf{H}_{k}\\ \mathbf{H}_{k}\mathbf{A}\end{bmatrix}\right],\end{aligned} \quad (13.28)
$$
...
$$
\begin{aligned}
\mathrm{GraphLayer}[\mathbf{H}_{k},\mathbf{A}]{\bf P}=\mathrm{GraphLayer}[\mathbf{H}_{k}{\bf P},{\bf P}^{T}\mathbf{A}{\bf P}],
\end{aligned} \quad (13.29)
$$
...
$$
\begin{aligned}
\mathbf{agg}[n]=\frac{1}{1+|\mathsf{ne}[n]|}\left(\mathbf{h}_{n}+\sum_{m\in\mathsf{ne}[n]}\mathbf{h}_{m}\right).
\end{aligned} \quad (13.30)
$$
