...
$$
\begin{aligned}\mathbf{H}_{k+1}&=\quad\mathbf{GraphLayer}[\mathbf{H}_{k},\mathbf{A}]\\&=\quad\mathbf{a}\left[\boldsymbol{\beta}_{k}\mathbf{1}^{T}+\boldsymbol{\Omega}_{k}\begin{bmatrix}\mathbf{H}_{k}\\ \mathbf{H}_{k}\mathbf{A}\end{bmatrix}\right],\end{aligned}
\tag{13.28}
$$
...
$$
\begin{aligned}
\mathrm{G r a p h L a y e r}[\mathbf{H}_{k},\mathbf{A}]{\bf P}=\mathrm{G r a p h L a y e r}[\mathbf{H}_{k}{\bf P},{\bf P}^{T}\mathbf{A}{\bf P}],
\tag{13.29}
\end{aligned}
$$
...
$$
\begin{aligned}
\mathbf{a}\mathrm{g g}[n]=\frac{1}{1+|\mathsf{n e}[n]|}\left(\mathbf{h}_{n}+\sum_{m\in\mathsf{n e}[n]}\mathbf{h}_{m}\right).
\tag{13.30}
\end{aligned}
$$
