...
$$
\begin{aligned}
\mathbf{H}_{k+1}=\mathbf{a}\Big[\boldsymbol{\beta}_{k}\mathbf{1}^{T}+\Omega_{k}\mathbf{H}_{k}(\mathbf{A}+\mathbf{I})\Big].
\end{aligned} \quad (13.13)
$$
...
$$
\begin{aligned}
\mathbf{H}_{k+1}=\mathbf{a}\Big[\boldsymbol{\beta}_{k}\mathbf{1}^{T}+\Omega_{k}\mathbf{H}_{k}(\mathbf{A}+(1+\epsilon_{k})\mathbf{I})\Big].
...
$$
\begin{array}{rcl}\mathbf{H}_{k+1}&=&\mathbf{a}\left[\boldsymbol{\beta}_{k}\mathbf{1}^{T}+\Omega_{k}\mathbf{H}_{k}\mathbf{A}+\boldsymbol{\Psi}_{k}\mathbf{H}_{k}\right]\\&=&\mathbf{a}\left[\boldsymbol{\beta}_{k}\mathbf{1}^{T}+\left[\Omega_{k}\quad\boldsymbol{\Psi}_{k}\right]\begin{bmatrix}\mathbf{H}_{k}\mathbf{A}\\ \mathbf{H}_{k}\end{bmatrix}\right]\\&=&\mathbf{a}\left[\boldsymbol{\beta}_{k}\mathbf{1}^{T}+\Omega_{k}^{\prime}\begin{bmatrix}\mathbf{H}_{k}\mathbf{A}\\ \mathbf{H}_{k}\end{bmatrix}\right],\quad(13.15)\end{array}
$$
...
$$
\begin{aligned}
\mathbf{H}_{k+1}=\left[\begin{array}{c}\mathbf{a}\left[\boldsymbol{\beta}_{k}\mathbf{1}^{T}+\Omega_{k}\mathbf{H}_{k}\mathbf{A}\right]\\ \mathbf{H}_{k}\end{array}\right].
...
$$
\begin{aligned}
\mathbf{a}\mathbf{g}[n]=\frac{1}{|\mathsf{ne}[n]|}\sum_{m\in\mathsf{ne}[n]}\mathbf{h}_{m},
