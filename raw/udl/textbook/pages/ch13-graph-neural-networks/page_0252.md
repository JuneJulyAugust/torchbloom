...
---
<p align="center">
  <img src="../../figures/page_0252_fig_1.jpg" alt="Figure 13.8 Inductive vs" />
</p>
...
However, each graph may have a different number of nodes. Hence, the matrices  $X\_{i}$  and  $A\_{i}$  have different sizes, and there is no way to concatenate them into 3D tensors.
