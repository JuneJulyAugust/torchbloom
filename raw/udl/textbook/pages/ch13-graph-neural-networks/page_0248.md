...
$$
\begin{aligned}\mathbf{H}_{1}&=\quad\mathbf{F}[\mathbf{X},\mathbf{A},\boldsymbol{\phi}_{0}]\\ \mathbf{H}_{2}&=\quad\mathbf{F}[\mathbf{H}_{1},\mathbf{A},\boldsymbol{\phi}_{1}]\\\vdots&=\quad\vdots\\ \mathbf{H}_{K}&=\quad\mathbf{F}[\mathbf{H}_{K-1},\mathbf{A},\boldsymbol{\phi}_{K-1}]\end{aligned} \quad (13.5)
$$
