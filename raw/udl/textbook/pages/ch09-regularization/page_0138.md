...
$$
\begin{aligned}
\hat{\boldsymbol{\phi}} &= \underset{\boldsymbol{\phi}}{\mathrm{arg\,min}}\left[L[\boldsymbol{\phi}]\right] \\
&= \underset{\boldsymbol{\phi}}{\mathrm{arg\,min}}\left[\sum_{i=1}^{I}\ell_{i}[\mathbf{x}_{i},\mathbf{y}_{i}]\right],
\end{aligned}
\qquad (9.1)
$$
