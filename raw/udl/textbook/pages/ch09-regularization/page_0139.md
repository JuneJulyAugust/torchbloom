...
$$
\begin{aligned}
\hat{\boldsymbol{\phi}}=\underset{\boldsymbol{\phi}}{\mathrm{a r g m i n}}\left[\sum_{i=1}^{I}\ell_{i}[\mathbf{x}_{i},\mathbf{y}_{i}]+\lambda\cdot\mathbf{g}[\boldsymbol{\phi}]\right], \tag{9.2}
\end{aligned}
$$
...
$$
\begin{aligned}
\hat{\boldsymbol{\phi}}=\underset{\boldsymbol{\phi}}{\mathrm{a r g m a x}}\left[\prod_{i=1}^{I}Pr(\mathbf{y}_{i}|\mathbf{x}_{i},\boldsymbol{\phi})\right]. \tag{9.3}
\end{aligned}
$$
