...
---
<p align="center">
  <img src="../../figures/page_0148_fig_1.jpg" alt="Figure 9.8 Dropout. a) Original network. b-d) At each training iteration, a random subset of hidden units is clamped to zero (gray nodes). The result is that th" />
</p>
