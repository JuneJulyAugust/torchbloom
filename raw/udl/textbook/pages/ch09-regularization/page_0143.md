...
$$
\begin{aligned}
\begin{align*}\tilde{L}_{SGD}[\phi]\quad&=\quad\tilde{L}_{GD}[\phi]+\frac{\alpha}{4B}\sum_{b=1}^{B}\left\|\frac{\partial L_{b}}{\partial\phi}-\frac{\partial L}{\partial\phi}\right\|^{2}\\&=\quad L[\phi]+\frac{\alpha}{4}\left\|\frac{\partial L}{\partial\phi}\right\|^{2}+\frac{\alpha}{4B}\sum_{b=1}^{B}\left\|\frac{\partial L_{b}}{\partial\phi}-\frac{\partial L}{\partial\phi}\right\|^{2}.\end{align*} \tag{9.9}
\end{aligned}
$$
...
$$
\begin{aligned}
L=\frac{1}{I}\sum_{i=1}^{I}l_{i}[x_{i},y_{i}]\qquad and\qquad L_{b}=\frac{1}{|B|}\sum_{i\in B_{b}}l_{i}[x_{i},y_{i}]. \tag{9.10}
\end{aligned}
$$
