...
Here,  $L_{b}$  is the loss for the  $b^{th}$  of the B batches in an epoch, and both L and  $L_{b}$  now represent the means of the I individual losses in the full dataset and the  $|B|$  individual losses in the batch, respectively:
