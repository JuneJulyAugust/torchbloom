...
$$
\frac{d\phi}{d t}\approx\mathbf{g}[\phi]+\alpha\mathbf{g}_{1}[\phi]+\cdots, \qquad (9.16)
$$

so that it gives the same result as the discrete version.

Consider the first two terms of a Taylor expansion of the modified continuous solution $\phi$ around initial position $\Phi\_{0}$:
