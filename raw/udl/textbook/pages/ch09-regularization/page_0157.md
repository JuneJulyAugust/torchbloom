...
$$
\begin{aligned}\frac{d\phi}{dt}&\approx\mathbf{g}[\phi]+\alpha\mathbf{g}_{1}[\phi]\\&=-\frac{\partial L}{\partial\phi}-\frac{\alpha}{2}\left(\frac{\partial^{2}L}{\partial\phi^{2}}\right)\frac{\partial L}{\partial\phi}.\\ \end{aligned} \tag{9.19}
$$
