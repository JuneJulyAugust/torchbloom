...
$$
\begin{aligned}
\phi[\alpha]\quad&\approx\quad\phi+\alpha\frac{d\phi}{dt}+\frac{\alpha^{2}}{2}\frac{d^{2}\phi}{dt^{2}}\bigg|_{\phi=\phi_{0}} \\
&\approx\quad\phi+\alpha(g[\phi]+\alpha g_{1}[\phi])+\frac{\alpha^{2}}{2}\left(\frac{\partial g[\phi]}{\partial\phi}g[\phi]+\alpha\frac{\partial g_{1}[\phi]}{\partial\phi}\frac{d\phi}{dt}\right)\bigg|_{\phi=\phi_{0}} \\
&=\quad\phi+\alpha(g[\phi]+\alpha g_{1}[\phi])+\frac{\alpha^{2}}{2}\left(g_{1}[\phi]+\frac{1}{2}\frac{\partial g[\phi]}{\partial\phi}g[\phi]\right)\bigg|_{\phi=\phi_{0}},
\end{aligned} \qquad (9.17)
$$
...
Note that the first two terms on the right-hand side $\phi\_{0} + \alpha g[\phi\_{0}]$ are the same as the discrete update (equation 9.14). Hence, to make the continuous and discrete versions arrive at the same place, the third term on the right-hand side must equal zero, allowing us to solve for $g\_{1}[\phi]$:

$$
\mathbf{g}_{1}[\phi]=-\frac{1}{2}\frac{\partial\mathbf{g}[\phi]}{\partial\phi}\mathbf{g}[\phi]. \qquad (9.18)
$$
...
$$
\begin{aligned}
\frac{d\phi}{dt}&\approx\mathbf{g}[\phi]+\alpha\mathbf{g}_{1}[\phi] \\
...
$$
L_{G D}[\phi]=L[\phi]+\frac{\alpha}{4}\left\|\frac{\partial L}{\partial\phi}\right\|^{2}, \qquad (9.20)
$$
