...
<p align="center">
  <img src="../../figures/page_0150_fig_1.jpg" alt="Figure 9.10 Adding noise to inputs. At each step of SGD, random noise with variance $\sigma_{x}^{2}$ is added to the batch data. a-c) Fitted model with differen" />
</p>
