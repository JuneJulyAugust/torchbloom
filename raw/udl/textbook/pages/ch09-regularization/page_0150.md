...
$$
\begin{aligned}
Pr(\phi|\{\mathbf{x}_{i},\mathbf{y}_{i}\})=\frac{\prod_{i=1}^{I}Pr(\mathbf{y}_{i}|\mathbf{x}_{i},\phi)Pr(\phi)}{\int\prod_{i=1}^{I}Pr(\mathbf{y}_{i}|\mathbf{x}_{i},\phi)Pr(\phi)d\phi},
\end{aligned}
\tag{9.11}
$$
