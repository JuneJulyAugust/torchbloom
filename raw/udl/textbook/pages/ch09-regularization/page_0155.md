...
---
<p align="center">
  <img src="../../figures/page_0155_fig_1.jpg" alt="Figure 9.14 Regularization methods. The regularization methods discussed in this chapter aim to improve generalization by one of four mechanisms. Some methods a" />
</p>
...
$$
\phi\leftarrow(1-\lambda^{\prime})\phi-\alpha\frac{\partial L}{\partial\phi}, \qquad (9.13)
$$
