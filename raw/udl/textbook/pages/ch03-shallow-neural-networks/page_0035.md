...
where $a[\bullet]$ is a nonlinear activation function. The model has parameters $\boldsymbol{\phi}=\lbrace \theta\_{\bullet\bullet},\phi\_{\bullet\bullet}\rbrace$. Figure 3.11 shows an example with three inputs, three hidden units, and two outputs.
