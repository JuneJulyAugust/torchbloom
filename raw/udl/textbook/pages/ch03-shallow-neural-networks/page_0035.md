...
where \(a[\bullet]\) is a nonlinear activation function. The model has parameters \(\boldsymbol{\phi}=\{\theta_{\bullet\bullet},\phi_{\bullet\bullet}\}\). Figure 3.11 shows an example with three inputs, three hidden units, and two outputs.
