...
$$
\begin{aligned}
\phi\leftarrow\phi+\alpha r\big[s t,a_{t}\big]+\gamma\cdot\max_{a}\Big[q[s_{t+1},a,\phi^{-}]\big]-q[s t,a_{t},\phi\big]. \tag{19.18}
\end{aligned}
$$
...
$$
\begin{aligned}
q[s_{t},a_{t}]\leftarrow q[s_{t},a_{t}]+\alpha\bigg(r[s_{t},a_{t}]+\gamma\cdot\max_{a}\big[q[s_{t+1},a]\bigg]-q[s_{t},a_{t}]\bigg) \tag{19.19}
\end{aligned}
$$
