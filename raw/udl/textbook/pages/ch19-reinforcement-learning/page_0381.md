...
---
<p align="center">
  <img src="../../figures/page_0381_fig_2.jpg" alt="Figure 19.8 Relationship between state values and action values" />
</p>

<p align="center">
  <strong>Figure 19.8</strong> Relationship between state values and action values. The value of state six v[s_{t}=6] is a weighted sum of the action values q[s_{t}=6, a_{t}] at state six, where the weights are the policy probabilities $\pi[a\_{t}|s\_{t}=6]$ of taking that action.
</p>

<p align="center">
  <img src="../../figures/page_0381_fig_1.jpg" alt="Figure 19.9 Relationship between action values and state values" />
</p>
