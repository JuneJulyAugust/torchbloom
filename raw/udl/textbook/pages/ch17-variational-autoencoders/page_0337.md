...
---
<p align="center">
  <img src="../../figures/page_0337_fig_1.jpg" alt="Figure 17.8 Variational approximation." />
</p>

<p align="center">
  <strong>Figure 17.8</strong> Variational approximation.
</p>
...
$$
\mathbb{E}_{\mathbf{z}}\big[\mathrm{a}[\mathbf{z}]]={\int}\mathrm{a}[\mathbf{z}|q(\mathbf{z}|\mathbf{x},\boldsymbol{\theta})d\mathbf{z}\approx\frac{1}{N}{\sum_{n=1}^{N}}\mathrm{a}[\mathbf{z}_{n}^{*}], \quad (17.22)
$$
...
$$
\mathrm{E L B O}[\boldsymbol{\theta},\phi]\quad\approx\quad\log\left[P r(\mathbf{x}|\mathbf{z}^{*},\boldsymbol{\phi})\right]-\mathrm{D}_{K L}\Big[q(\mathbf{z}|\mathbf{x},\boldsymbol{\theta})\Big|\Big|P r(\mathbf{z})\Big]. \quad (17.23)
$$
...
$$
\mathrm{D}_{K L}\left[q(\mathbf{z}|\mathbf{x},\boldsymbol{\theta})\Big|\big|P r(\mathbf{z})\right]=\frac{1}{2}\bigg(\mathrm{T r}[\boldsymbol{\Sigma}]+\boldsymbol{\mu}^{T}\boldsymbol{\mu}-D_{\mathbf{z}}-\log\left[\mathrm*{d e t}[\boldsymbol{\Sigma}]\right]\bigg). \quad (17.24)
$$
