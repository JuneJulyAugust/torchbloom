...
$$
\mathrm{D}_{KL}\left[q(\mathbf{z}|\mathbf{x})\middle|\Big|Pr(\mathbf{z}|\mathbf{x},\phi)\right]=\int q(\mathbf{z}|\mathbf{x})\log\left[\frac{q(\mathbf{z}|\mathbf{x})}{Pr(\mathbf{z}|\mathbf{x},\phi)}\right]d\mathbf{z}. \quad (17.32)
$$
...
$$
\frac{\partial}{\partial\phi}\mathbb{E}_{Pr(x|\phi)}\left[\mathbf{f}[x]\right], \quad (17.33)
$$
