...
$$
g\left[\mathbb{E}[y]\right]\leq\mathbb{E}\left[g[y]\right]. \quad (17.31)
$$
...
$$
\mathrm{D}_{K L}\left[q(\mathbf{z}|\mathbf{x})\middle|\Big|P r(\mathbf{z}|\mathbf{x},\phi)\right]=\int q(\mathbf{z}|\mathbf{x})\log\left[\frac{q(\mathbf{z}|\mathbf{x})}{P r(\mathbf{z}|\mathbf{x},\phi)}\right]d\mathbf{z}. \quad (17.32)
$$
...
$$
\frac{\partial}{\partial\phi}\mathbb{E}_{P r(x|\phi)}\left[\mathbf{f}[x]\right], \quad (17.33)
$$
...
$$
\begin{align*}\frac{\partial}{\partial\phi}\mathbb{E}_{Pr(x|\phi)}\left[\mathbf{f}[x]\right]&=\quad\mathbb{E}_{Pr(x|\phi)}\left[\mathbf{f}[x]\frac{\partial}{\partial\phi}\log\left[Pr(x|\phi)\right]\right]\\&\approx\quad\frac{1}{I}\sum_{i=1}^{I}\mathbf{f}[x_{i}]\frac{\partial}{\partial\phi}\log\left[Pr(x_{i}|\phi)\right].\end{align*} \quad (17.34)
$$
