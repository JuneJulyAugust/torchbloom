...
---
<p align="center">
  <img src="../../figures/page_0329_fig_1.jpg" alt="Figure 17.1 Mixture of Gaussians (MoG)." />
</p>

<p align="center">
  <strong>Figure 17.1</strong> Mixture of Gaussians (MoG).
</p>
...
$$
Pr(\mathbf{x}|\mathbf{z},\boldsymbol{\phi})=\mathrm{Norm}_{\mathbf{x}}\Big[\mathbf{f}[\mathbf{z},\boldsymbol{\phi}],\sigma^{2}\mathbf{I}\Big]. \quad (17.6)
$$
...
$$
\begin{align*}Pr(\mathbf{x}|\boldsymbol{\phi})&=\int Pr(\mathbf{x},\mathbf{z}|\boldsymbol{\phi})d\mathbf{z}\\&=\int Pr(\mathbf{x}|\mathbf{z},\boldsymbol{\phi})\cdot Pr(\mathbf{z})d\mathbf{z}\\&=\int Norm_{\mathbf{x}}\Big[\mathbf{f}[\mathbf{z},\boldsymbol{\phi}],\sigma^{2}\mathbf{I}\Big]\cdot Norm_{\mathbf{z}}\left[\boldsymbol{0},\mathbf{I}\right]d\mathbf{z}.\end{align*} \quad (17.7)
$$
...
Appendix C.4.2 Ancestral sampling
