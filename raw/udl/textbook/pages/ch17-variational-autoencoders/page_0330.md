...
---
<p align="center">
  <img src="../../figures/page_0330_fig_1.jpg" alt="Figure 17.2 Nonlinear latent variable model. A complex 2D density Pr( mathbf x , z) (left) over the latent variable z; to create Pr( mathbf x ) , we integrate the 3D volume over th" />
</p>
...
<p align="center">
  <img src="../../figures/page_0330_fig_2.jpg" alt="Figure 17.3 Generation from nonlinear latent variable model. a) We draw a sample z from the prior probability Pr(z) over the latent variable. b) A sample x is then drawn from Pr( m" />
</p>
