...
$$
\hat{\boldsymbol{\phi}}\quad=\quad\underset{\boldsymbol{\phi}}{\mathrm{a r g m a x}}\left[\sum_{i=1}^{I}\log\left[P r(\mathbf{x}_{i}|\boldsymbol{\phi})\right]\right], \quad (17.8)
$$

 where: 

$$
\hat{\boldsymbol{p}}\quad=\quad\underset{\phi}{\mathrm{a r g m a x}}[\sum_{i=1}^{I}\log\left[P r(\mathbf{x}_{i}|\boldsymbol{\phi})\right], \quad (17.9)
$$

 where: 

$$
P r(\mathbf{x}_{i}|\boldsymbol{\phi})\quad=\quad\int\mathrm{N o r m}_{\mathbf{x}_{i}}[\mathbf{f}[\mathbf{z},\boldsymbol{\phi}],\sigma^{2}\mathbf{I}]\cdot\mathrm{N o r m}_{\mathbf{z}}[\mathbf{0},\mathbf{I}]d\mathbf{z}. \quad (17.9)
$$
