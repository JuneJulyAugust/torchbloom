...
---
<p align="center">
  <img src="../../figures/page_0130_fig_1.jpg" alt="Figure 8.10 Double descent. a) Training and test error on MNIST-1D for a two-hidden layer network as we increase the number of hidden units (and hence parameters) in each layer. Th" />
</p>
