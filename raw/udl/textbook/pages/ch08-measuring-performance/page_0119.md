...
---
<p align="center">
  <img src="../../figures/page_0119_fig_1.jpg" alt="Figure 8.1 MNIST-1D. a) Templates for 10 classes $y \in \lbrace 0, \ldots, 9\rbrace$, based on digits 0–9. b) Training examples $x$ are created by randomly transforming a template a" />
</p>
...
<p align="center">
  <img src="../../figures/page_0119_fig_2.jpg" alt="Figure 8.2 MNIST-1D results. a) Percent classification error as a function of the training step. The training set errors decrease to zero, but the test errors do not drop below $\s" />
</p>
