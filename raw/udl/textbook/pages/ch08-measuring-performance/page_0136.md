...
Problem 8.3 $^{*}$  Given a training dataset consisting of I input/output pairs  $\lbrace x\_{i}, y\_{i} \rbrace$, show how the model in figure 8.4a using the least squares loss function can be found in closed form.
