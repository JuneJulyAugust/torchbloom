...
---
<p align="center">
  <img src="../../figures/page_0131_fig_1.jpg" alt="Figure 8.11 Increasing capacity (hidden units) allows smoother interpolation between sparse data points. a) Consider this situation where the training data (ora" />
</p>
