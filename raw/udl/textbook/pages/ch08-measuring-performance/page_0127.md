...
---
<p align="center">
  <img src="../../figures/page_0127_fig_1.jpg" alt="Figure 8.7 Bias and variance as a function of model capacity. a-c) As we increase the number of hidden units of the toy model, the number of linear regions incr" />
</p>
