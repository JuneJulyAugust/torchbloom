...
<p align="center">
  <img src="../../figures/page_0128_fig_2.jpg" alt="Figure 8.8 Overfitting. a-c) A model with three regions is fit to three different datasets of fifteen points each. The result is similar in all three cases (i.e" />
</p>
...
<p align="center">
  <img src="../../figures/page_0128_fig_1.jpg" alt="Figure 8.9 Bias-variance trade-off. The bias and variance terms from equation 8.7 are plotted as a function of the model capacity (number of hidden units / line" />
</p>
