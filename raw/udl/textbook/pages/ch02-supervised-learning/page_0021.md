...
$$
\begin{aligned}
\hat{\phi} &= \underset{\phi}{\mathrm{arg\,min}}\left[L[\phi]\right]\\
&= \underset{\phi}{\mathrm{arg\,min}}\left[\sum_{i=1}^{I}\left(f[x_i,\phi]-y_i\right)^2\right]\\
&= \underset{\phi}{\mathrm{arg\,min}}\left[\sum_{i=1}^{I}\left(\phi_0+\phi_1x_i-y_i\right)^2\right].
\end{aligned}
\quad (2.6)
$$
