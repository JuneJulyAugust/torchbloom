...
$$
\hat{\phi}=\underset{\phi}{\mathrm{argmin}}\left[L[\phi]\right]. \quad (2.3)
$$
...
[^1]: More properly, the loss function also depends on the training data $\lbrace x\_i,y\_i\rbrace$, so we should write $L[\lbrace x\_i,y\_i\rbrace,\phi]$, but this is rather cumbersome.
