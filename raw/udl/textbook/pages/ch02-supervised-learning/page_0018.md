...
$$
\hat{\phi}=\underset{\phi}{\mathrm{arg\,min}}\left[L[\phi]\right]. \quad (2.3)
$$
...
[^1]: More properly, the loss function also depends on the training data $\lbrace x_i,y_i\rbrace$, so we should write $L[\lbrace x_i,y_i\rbrace,\phi]$, but this is rather cumbersome.
