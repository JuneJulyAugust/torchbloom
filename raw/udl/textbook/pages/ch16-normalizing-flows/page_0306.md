...
---
<p align="center">
  <img src="../../figures/page_0306_fig_1.jpg" alt="Figure 16.3 Inverse mapping (normalizing direction). - Labels: b)" />
</p>

<p align="center">
  <strong>Figure 16.3</strong> Inverse mapping (normalizing direction).
</p>
...
$$
P r(x|\phi)\quad=\quad\left|\frac{\partial\mathrm{f}[z,\phi]}{\partial z}\right|^{-1}\cdot P r(z), \quad (16.1)
$$
