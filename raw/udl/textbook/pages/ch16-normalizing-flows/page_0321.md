...
$$
\hat{\boldsymbol{\phi}}=\underset{\boldsymbol{\phi}}{\mathop{\mathrm{arg\,min}}}\left[\mathrm{KL}\left[\frac{1}{I}\sum_{i=1}^{I}\delta\left[\mathbf{x}-\mathrm{f}[\boldsymbol{z}_{i},\boldsymbol{\phi}]\right]\middle\|q(\mathbf{x})\right]\right]
\qquad (16.25)
$$
...
$$
\hat{\boldsymbol{\phi}}=\underset{\boldsymbol{\phi}}{\mathop{\mathrm{arg\,min}}}\left[\mathrm{KL}\left[\frac{1}{I}\sum_{i=1}^{I}\delta\left[\mathbf{x}-\boldsymbol{\mathrm{x}}_{i}\right]\middle\|\Pr(\mathbf{x}_{i},\boldsymbol{\phi})\right]\right]
\qquad (16.26)
$$
