...
$$
\hat{\boldsymbol{\phi}}=\underset{\boldsymbol{\phi}}{\mathrm{argmin}}\left[\mathrm{KL}\left[\frac{1}{I}\sum_{i=1}^{I}\delta\left[\mathbf{x}-\mathrm{f}[\boldsymbol{z}_{i},\boldsymbol{\phi}]\right]\middle|\left|q(\mathbf{x})\right.\right]\right]. \quad (16.25)
$$
...
$$
\hat{\boldsymbol{\phi}}=\underset{\boldsymbol{\phi}}{\mathrm{argmin}}\left[\mathrm{KL}\left[\frac{1}{I}\sum_{i=1}^{I}\delta\left[\mathbf{x}-\boldsymbol{\mathrm{x}}_{i}\right]\middle|\left|Pr(\mathbf{x}_{i},\boldsymbol{\phi})\right.\right]\right]. \quad (16.26)
$$
