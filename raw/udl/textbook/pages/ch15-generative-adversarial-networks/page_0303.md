...
Problem 15.2* Write an equation relating the loss $L$ in equation 15.8 to the Jensen-Shannon distance $D_{JS}[\Pr[\mathbf{x}^{*}] \Vert \Pr[\mathbf{x}]]$ in equation 15.9.
