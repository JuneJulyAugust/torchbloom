...
$$
\begin{aligned}
\hat{\boldsymbol{\phi}}=\underset{\boldsymbol{\phi}}{\mathrm{argmin}}\left[-\sum_{i=1}^{I}\log\left[Pr(y_{i}|\mathbf{f}[\mathbf{x}_{i},\boldsymbol{\phi}])\right]\right].
