...
---
<p align="center">
  <img src="../../figures/page_0075_fig_1.jpg" alt="Figure 5.14 Multimodal data and mixture of Gaussians density. a) Example training data where, for intermediate values of the input x, the corresponding output y" />
</p>
...
$$
\begin{aligned}
P r(y|\lambda,\mu_{1},\mu_{2},\sigma_{1}^{2},\sigma_{2}^{2})=\frac{\lambda}{\sqrt{2\pi\sigma_{1}^{2}}}\exp\left[\frac{-{(y-\mu_{1})}^{2}}{2\sigma_{1}^{2}}\right]+\frac{1-\lambda}{\sqrt{2\pi\sigma_{2}^{2}}}\exp\left[\frac{-{(y-\mu_{2})}^{2}}{2\sigma_{2}^{2}}\right], \tag{5.35}
\end{aligned}
$$
