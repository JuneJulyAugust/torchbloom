...
\begin{aligned}
L[\boldsymbol{\phi}]
&=-\sum_{i=1}^{I}\log\left[\Pr\left(\mathbf{y}_i\,|\,\mathbf{f}[\mathbf{x}_i,\boldsymbol{\phi}]\right)\right] \\
&=-\sum_{i=1}^{I}\sum_d\log\left[\Pr\left(y_{id}\,|\,\mathbf{f}_d[\mathbf{x}_i,\boldsymbol{\phi}]\right)\right].
