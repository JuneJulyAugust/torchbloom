...
$$
\begin{aligned}
L[\boldsymbol{\phi}]=-\sum_{i=1}^{I}\log\left[Pr(\mathbf{y}_{i}|\mathbf{f}[\mathbf{x}_{i},\boldsymbol{\phi}])\right]=-\sum_{i=1}^{I}\sum_{d}\log\left[Pr(y_{id}|\mathbf{f}_{d}[\mathbf{x}_{i},\boldsymbol{\phi}])\right].
\end{aligned}
\tag{5.26}
$$
