...
<p align="center">
  <strong>Figure 5.9</strong> Categorical distribution. The categorical distribution assigns probabilities to K >2 categories, with associated probabilities \lambda1, \lambda2,..., \lambdaK. Here, there are five categories, so K = 5. To ensure that this is a valid probability distribution, each parameter \lambdak must lie in the range [0, 1], and all K parameters must sum to one
</p>
