...
---
<p align="center">
  <img src="../../figures/page_0071_fig_1.jpg" alt="Figure 5.12 Cross-entropy method. a) Empirical distribution of training samples (arrows denote Dirac delta functions). b) Model distribution (a normal distribut" />
</p>

<p align="center">
  <strong>Figure 5.12</strong> Cross-entropy method. a) Empirical distribution of training samples (arrows denote Dirac delta functions). b) Model distribution (a normal distribution with parameters  $\theta = \lbrace \mu, \sigma^{2}\rbrace$ ). In the cross-entropy approach, we minimize the distance (KL divergence) between these two distributions as a function of the model parameters  $\theta$ .
</p>
...
$$
\begin{aligned}
D_{K L}\left[q||p\right]=\int_{-\infty}^{\infty}q(z)\log\left[q(z)\right]d z-\int_{-\infty}^{\infty}q(z)\log\left[p(z)\right]d z. \tag{5.27}
\end{aligned}
$$
...
$$
\begin{aligned}
\begin{align*}\hat{\boldsymbol{\theta}}\ =&\ \underset{\boldsymbol{\theta}}{\mathrm{argmin}}\left[\int_{-\infty}^{\infty}q(y)\log\left[q(y)\right]dy-\int_{-\infty}^{\infty}q(y)\log\left[Pr(y|\boldsymbol{\theta})\right]dy\right]\\=&\ \underset{\boldsymbol{\theta}}{\mathrm{argmin}}\left[-\int_{-\infty}^{\infty}q(y)\log\left[Pr(y|\boldsymbol{\theta})\right]dy\right],\end{align*} \tag{5.29}
\end{aligned}
$$
