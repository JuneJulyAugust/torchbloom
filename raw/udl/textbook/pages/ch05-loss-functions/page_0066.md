...
$$
\begin{aligned}
Pr(y|\mathbf{x})=(1-\mathrm{sig}[f[\mathbf{x},\boldsymbol{\phi}]])^{1-y}\cdot\mathrm{sig}[f[\mathbf{x}_{i},\boldsymbol{\phi}]]^{y}. \tag{5.19}
\end{aligned}
$$
...
$$
\begin{aligned}
L[\phi]=\sum_{i=1}^{I}-(1-y_{i})\log\left[1-\mathrm{sig}[f[\mathbf{x}_{i},\boldsymbol{\phi}]]\right]-y_{i}\log\left[\mathrm{sig}[f[\mathbf{x}_{i},\boldsymbol{\phi}]]\right]. \tag{5.20}
\end{aligned}
$$
