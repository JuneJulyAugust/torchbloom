...
**Problem 5.1** $$
\begin{aligned}
\mathrm{sig}[z]=\frac{1}{1+\exp[-z]}. \quad (5.18)
\end{aligned}
$$
...
$$
\begin{aligned}
Pr(y|\mathbf{x})=(1-\mathrm{sig}[f[\mathbf{x},\boldsymbol{\phi}]])^{1-y}\cdot\mathrm{sig}[f[\mathbf{x}_{i},\boldsymbol{\phi}]]^{y}. \quad (5.19)
\end{aligned}
$$
...
$$
\begin{aligned}
L[\phi]=\sum_{i=1}^{I}-(1-y_{i})\log\left[1-\mathrm{sig}[f[\mathbf{x}_{i},\boldsymbol{\phi}]]\right]-y_{i}\log\left[\mathrm{sig}[f[\mathbf{x}_{i},\boldsymbol{\phi}]]\right]. \quad (5.20)
\end{aligned}
$$
