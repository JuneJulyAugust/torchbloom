...
$$
\begin{aligned}
\hat{\phi},\hat{\sigma}^{2}=\underset{\phi,\sigma^{2}}{\mathrm{argmin}}\left[-\sum_{i=1}^{I}\log\left[\frac{1}{\sqrt{2\pi\sigma^{2}}}\exp\Big[-\frac{(y_{i}-\mathrm{f}[\mathbf{x}_{i},\phi])^{2}}{2\sigma^{2}}\Big]\right].\right. \tag{5.13}
\end{aligned}
$$
...
$$
\begin{aligned}
\begin{array}{r c l}{\mu}&{=}&{\mathrm{f}_{1}[\mathbf{x},\phi]}\\ {\sigma^{2}}&{=}&{\mathrm{f}_{2}[\mathbf{x},\phi]^{2},}\\ \end{array} \tag{5.14}
\end{aligned}
$$
...
$$
\begin{aligned}
\hat{\phi}=\underset{\phi}{\mathrm{argmin}}\left[-\sum_{i=1}^{I}\Bigg(\log\left[\frac{1}{\sqrt{2\pi f_{2}[\mathbf{x}_{i},\phi]^{2}}}\right]-\frac{(y_{i}-\mathrm{f}_{1}[\mathbf{x}_{i},\phi])^{2}}{2f_{2}[\mathbf{x}_{i},\phi]^{2}}\Bigg)\right]. \tag{5.15}
\end{aligned}
$$
