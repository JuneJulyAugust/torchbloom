...
&= \mathop{\mathrm{arg\,max}}_{\boldsymbol{\phi}}\left[\log\left[\prod_{i=1}^{I}\Pr\left(\mathbf{y}_{i}\,|\,\mathbf{f}[\mathbf{x}_{i},\boldsymbol{\phi}]\right)\right]\right] \\
&= \mathop{\mathrm{arg\,max}}_{\boldsymbol{\phi}}\left[\sum_{i=1}^{I}\log\left[\Pr\left(\mathbf{y}_{i}\,|\,\mathbf{f}[\mathbf{x}_{i},\boldsymbol{\phi}]\right)\right]\right].
