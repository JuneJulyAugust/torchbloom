...
---
<p align="center">
  <img src="../../figures/page_0076_fig_1.jpg" alt="Figure 5.15 Poisson distribution. This discrete distribution is defined over non-negative integers $z \in \lbrace 0,1,2,\ldots\rbrace$ . It has a single paramet" />
</p>

<p align="center">
  <strong>Figure 5.15</strong> Poisson distribution. This discrete distribution is defined over non-negative integers  $z \in \lbrace 0,1,2,\ldots\rbrace$ . It has a single parameter  $\lambda \in R^{+}$ , which is known as the rate and is the mean of the distribution. a–c) Poisson distributions with rates of 1.4, 2.8, and 6.0, respectively.
</p>
...
$$
\begin{aligned}
P r(y=k)=\frac{\lambda^{k}e^{-\lambda}}{k!}. \tag{5.36}
\end{aligned}
$$
