...
---
<p align="center">
  <img src="../../figures/page_0074_fig_1.jpg" alt="Figure 5.13 The von Mises distribution is defined over the circular domain It has two parameters The mean determines the position of the pea" />
</p>
...
\end{aligned} \qquad (5.33)
$$

where $\mathrm{sig}[\bullet]$ is defined in equation 5.32. Plot this loss as a function of the transformed network output $\mathrm{sig}[f[x, \phi]] \in [0, 1]$ (i) when the training label $y = 0$ and (ii) when $y = 1$.
...
$$
\begin{aligned}
\Pr\left(y\mid\mu,\kappa\right) &= \frac{\exp[\kappa\cos[y-\mu]]}{2\pi\cdot\mathrm{Bessel}_0[\kappa]}
\end{aligned} \qquad (5.34)
$$
