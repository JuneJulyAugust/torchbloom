...
---
<p align="center">
  <img src="../../figures/page_0173_fig_1.jpg" alt="Figure 10.11 Methods for scaling down representation size (downsampling). a) Sub-sampling. The original representation (left) is reduced to size (right) by reta" />
</p>
...
<p align="center">
  <img src="../../figures/page_0173_fig_2.jpg" alt="Figure 10.12 Methods for scaling up representation size (upsampling). a) The simplest way to double the size of a 2D layer is to duplicate each input four times" />
</p>
...
<p align="center">
  <img src="../../figures/page_0173_fig_3.jpg" alt="Figure 10.13 Transposed convolution in 1D. a) Downsampling with kernel size three, stride two, and zero-padding. Each output is a weighted sum of three inputs (" />
</p>
