...
---
<p align="center">
  <img src="../../figures/page_0162_fig_1.jpg" alt="Figure 10.1 Invariance and equivariance for translation. a–b) In image classification, the goal is to categorize both im" />
</p>
...
$$
\mathbf{f}[\mathbf{t}[\mathbf{x}]]=\mathbf{t}\left[\mathbf{f}[\mathbf{x}]\right]. \quad (10.2)
$$
