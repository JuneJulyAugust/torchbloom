...
$$
\begin{aligned}h_{i}\quad&=\quad a\left[\beta+\sum_{j=1}^{3}\omega_{j}x_{i+j-2}\right],\\&=\quad a\left[\beta+\sum_{j=1}^{3}\omega_{j}x_{i+j-2}+\omega_{3}x_{i+1}+a\omega_{3}\right].\end{aligned} \quad (10.4)
$$
...
$$
h_{i}\quad=\quad a\left[\beta_{i}+\sum_{j=1}^{D}\omega_{ij}x_{j}\right]. \quad (10.5)
$$
