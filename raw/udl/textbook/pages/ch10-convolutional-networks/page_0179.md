...
---
<p align="center">
  <img src="../../figures/page_0179_fig_1.jpg" alt="Figure 10.19 Semantic segmentation network of Noh et al. (2015). The input is a image, which is passed through a version of the VGG network and eventually trans" />
</p>

<p align="center">
  <strong>Figure 10.19</strong> Semantic segmentation network of Noh et al. (2015). The input is a $224 \times 224$ image, which is passed through a version of the VGG network and eventually transformed into a representation of size 4096 using a fully connected layer. This contains information about the entire image. This is then reformed into a representation of size $7 \times 7$ using another fully connected layer, and the image is upsampled and deconvolved (transposed convolutions without upsampling) in a mirror image of the VGG network. The output is a $224 \times 224 \times 21$ representation that gives the output probabilities for the 21 classes at each position.
</p>
