...
Source: https://www.mathacademy.com/topics/2354?courseId=113
Topic ID: 2354

## Prerequisites

- [Adding Mixed Numbers With Like Denominators](../../../elementary-school/lessons/grade-4/2352-adding-mixed-numbers-with-like-denominators.md)
...
****: Adding the whole numbers, we get $5+2 = {\color{red}{7}}.$
...
****: Adding the whole numbers, we get $2+5 = {\color{red}{7}}.$
...
- To put $\dfrac 1 6$ over a denominator of $24,$ we multiply the numerator and denominator by $4\mathbin{:}$
...
### Example: Adding Mixed Numbers When the Sum of the Fractional Parts is a Mixed Number
...
****: Adding the whole numbers, we get $1+3 = {\color{red}{4}}.$
