...
Source: https://www.mathacademy.com/topics/2365?courseId=113
Topic ID: 2365

## Prerequisites

- [Equivalent Fractions](../../../elementary-school/lessons/grade-4/2363-equivalent-fractions.md)
...
### Example: Finding the Least Common Denominator when One Denominator is a Multiple of Another

#### Question

Determine the least common denominator of $\dfrac{5}{8}$ and $\dfrac{1}{4}.$
...
### Example: Finding the Least Common Denominator when Both Denominators are Single-Digit
...
### Example: Finding the Least Common Denominator when One Denominator is Double-Digit
...
### Example: Finding the Least Common Denominator when Both Denominators are Double-Digit
