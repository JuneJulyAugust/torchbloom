...
Source: https://www.mathacademy.com/topics/2356?courseId=113
Topic ID: 2356

## Prerequisites

- [Adding Mixed Numbers With Unlike Denominators](./2354-adding-mixed-numbers-with-unlike-denominators.md)
...
\begin{aligned}\frac{6}{8}−\frac{1}{8}=\frac{5}{8}\end{aligned}
...
### Example: Subtracting Two Mixed Numbers
...
****: Subtracting the whole numbers, we get $6-3 = {\color{red}{3}}.$
...
To put $\dfrac 1 2$ over a denominator of $10,$ we multiply the numerator and denominator by $5$:
...
\begin{aligned}\frac{5}{10}−\frac{3}{10}=\frac{2}{10}\end{aligned}
...
****: Subtracting the whole numbers, we get $2-2 = {\color{red}{0}}.$
...
To put $\dfrac 2 3$ over a denominator of $12,$ we multiply the numerator and denominator by $4$:
...
\begin{aligned}\frac{2}{3}−\frac{1}{4}=\frac{8}{12}−\frac{3}{12}=\frac{5}{12}\end{aligned}
...
****: Subtracting the whole numbers, we get $5-3 = {\color{red}{2}}.$
...
\begin{aligned}\frac{3}{4}−\frac{1}{6}=\frac{9}{12}−\frac{2}{12}=\frac{7}{12}\end{aligned}
