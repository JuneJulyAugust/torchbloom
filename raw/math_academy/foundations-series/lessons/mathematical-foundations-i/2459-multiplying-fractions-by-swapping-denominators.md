...
Source: https://www.mathacademy.com/topics/2459?courseId=113
Topic ID: 2459
...
### Example: Interpreting Multiplication and Division as Fraction Multiplication
...
### Example: Writing an Expression as an Equivalent Product of Fractions

#### Question

Find an expression of the form $\,0\,$ equivalent to $\dfrac{4}{3}\times\dfrac{9}{2}.$
...
### Example: Cases Where the Answer Is a Whole Number
...
\begin{aligned}\underset{3}{\underset{}{\frac{12}{4}}}×\underset{3}{\underset{}{\frac{21}{7}}}=3×3=9.\end{aligned}
...
\begin{aligned}\frac{3÷3}{12÷3}×\frac{1}{8} & =\frac{1}{4}×\frac{1}{8}\end{aligned}
...
### Example: Cases Where the Answer Is a Fraction
