...
Source: https://www.mathacademy.com/topics/4197?courseId=113
Topic ID: 4197
...
The base unit for time is the **second**, which we denote using the symbol "$\text{s}.$" We measure the time between two events using clocks like the ones shown below.

![Instructional graphic](../../../lesson-assets/mathematical-foundations-i/topic-4197/ea5ea6a4b2516bf8.png)

We use **milliseconds** to measure smaller time intervals. The symbol for milliseconds is "$\text{ms}.$" The prefix $\textrm m$ stands for **milli,** which means $\dfrac{1}{1\,000}.$ Therefore, $1\,\text{ms}$ equals $\dfrac{1}{1\,000}\,\textrm s.$

Notice that if we add $1\,\text{ms}$ to itself $1\,000$ times, we get exactly $1\,\text{s}{:}$

$$


\begin{aligned}\overset{1\,ms+1\,ms+⋯+1\,ms}{1\,000 times} & = \\ \frac{1}{1\,000}\,s+\frac{1}{1\,000}\,s+⋯+\frac{1}{1\,000}\,s & = \\ 1\,000×\frac{1}{1\,000}\,s & = \\ \frac{1\,000×1}{1\,000}\,s & = \\ \frac{1\,000}{1\,000}\,s & = \\ 1\,s & \end{aligned}


$$

Therefore, $1\,000\,\text{ms}$ equals $1\,\text{s},$ as stated in the diagram.
...
Therefore, from the given options, the only unit of time is $\text{ms}.$
...
A fitness class lasts exactly $1\,\text{h}.$ What is this time in minutes?

#### Explanation

A table showing the units of time is given below.

Therefore, $1\,\text{h}$ is equivalent to $60\,\text{min}.$
