...
Source: https://www.mathacademy.com/topics/2381?courseId=113
Topic ID: 2381
...
### Example: Expressing the Result as an Improper Fraction
...
\begin{aligned}\frac{3}{2}×\frac{7}{3}\end{aligned}
...
\begin{aligned}\frac{3}{2}×\frac{7}{3} & =\frac{3}{3}×\frac{7}{2} \\ & =1×\frac{7}{2} \\ & =\frac{7}{2}\end{aligned}
...
### Example: Cases When the Result is a Whole Number
...
\begin{aligned}\frac{3}{2}×\frac{4}{3}\end{aligned}
...
\begin{aligned}\frac{3}{2}×\frac{4}{3} & =\frac{3}{3}×\frac{4}{2} \\ & =1×2 \\ & =2\end{aligned}
...
### Example: Expressing the Result as a Mixed Number
...
### Example: Expressing the Result as a Mixed Number (Solution Uses a Strategy)
...
\begin{aligned}\frac{7}{3}×\frac{9}{4}\end{aligned}
...
\begin{aligned}\frac{7}{3}×\frac{9}{4} & =\frac{7}{4}×\frac{9}{3} \\ & =\frac{7}{4}×3 \\ & =\frac{21}{4}\end{aligned}
