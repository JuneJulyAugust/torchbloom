...
Source: https://www.mathacademy.com/topics/525?courseId=113
Topic ID: 525

## Prerequisites

- [Subtracting Mixed Numbers With Unlike Denominators](./2356-subtracting-mixed-numbers-with-unlike-denominators.md)
- [Subtracting Mixed Numbers With Like Denominators Using Improper Fractions](../../../elementary-school/lessons/grade-4/2362-subtracting-mixed-numbers-with-like-denominators-using-improper-fractions.md)
...
Writing $4 \, \dfrac{1}{6}$ as an improper fraction, we have:
...
Writing $2 \, \dfrac{1}{3}$ as an improper fraction, we have:
...
\begin{aligned}\frac{25}{6}−\frac{14}{6}=\frac{11}{6}\end{aligned}


$$

### Example: Finding a Missing Numerator
...
\dfrac{46}{9} - \dfrac{39}{9} = \dfrac{\boxed{7}}{9}
...
### Example: Subtracting Mixed Numbers Using Improper Fractions
...
\begin{aligned}\frac{17}{4}−\frac{10}{4}=\frac{7}{4}\end{aligned}
...
\begin{aligned}\frac{1}{8}−\frac{1}{4} & =\frac{1}{8}−\frac{2×1}{2×4} \\ & =\frac{1}{8}−\frac{2}{8}\end{aligned}


$$

However, we cannot carry out this subtraction since the first fraction is ** than the second!
...
### Example: Converting a Result Greater Than Two to a Mixed Number
...
\begin{aligned}\frac{1}{8}−\frac{1}{2} & =\frac{1}{8}−\frac{4×1}{4×2} \\ & =\frac{1}{8}−\frac{4}{8}\end{aligned}
