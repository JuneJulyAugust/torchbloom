...
Source: https://www.mathacademy.com/topics/2475?courseId=113
Topic ID: 2475
...
Evaluate $5\times \left(3+2^2\right).$

#### Explanation

According to PEMDAS, we should first calculate the expression inside the ****arentheses: $\left(3+2^2\right).$
