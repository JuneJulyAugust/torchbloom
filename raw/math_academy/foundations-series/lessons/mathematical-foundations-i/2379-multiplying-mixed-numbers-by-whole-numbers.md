...
Source: https://www.mathacademy.com/topics/2379?courseId=113
Topic ID: 2379
...
and the mixed number $2\,\dfrac 3{4}$ can be expressed as the improper fraction
...
We also write $1\,\dfrac{2}{7}$ as an improper fraction:
...
### Example: Cases Where Simplification Is Needed
...
### Example: Simplifying Using a Strategy
...
First, we write $2\,\dfrac{2}{9}$ as an improper fraction:
...
\begin{aligned}\frac{20}{9}×\frac{3}{1} & =\frac{20}{1}×\frac{3}{9} \\ & =20×\frac{1}{3} \\ & =\frac{20×1}{3} \\ & =\frac{20}{3}\end{aligned}
