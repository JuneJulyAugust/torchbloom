...
Source: https://www.mathacademy.com/topics/685?courseId=111
Topic ID: 685

## Prerequisites

- [Translating Between Explicit and Recursive Formulas for Geometric Sequences](./2215-translating-between-explicit-and-recursive-formulas-for-geometric-sequences.md)
- [Finding the Common Ratio of a Geometric Sequence Given Two Terms](./2534-finding-the-common-ratio-of-a-geometric-sequence-given-two-terms.md)
