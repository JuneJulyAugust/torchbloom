...
Source: https://www.mathacademy.com/topics/68?courseId=44
Topic ID: 68

## Prerequisites

- [Equivalent Expressions With Fractions](./1297-equivalent-expressions-with-fractions.md)
- [Evaluating Rational Expressions](../../../../middle-school/lessons/prealgebra/2183-evaluating-rational-expressions.md)
...
\begin{aligned}\frac{4(2𝑥−3)}{2} & = \\ \frac{2⋅2⋅(2𝑥−3)}{2} & = \\ \frac{2}{2}⋅\frac{2⋅(2𝑥−3)}{1}. & \end{aligned}
...
\begin{aligned}\frac{2}{2}⋅\frac{2⋅(2𝑥−3)}{1} & = \\ 1⋅\frac{2⋅(2𝑥−3)}{1} & = \\ \frac{2⋅(2𝑥−3)}{1} & \\ 2(2𝑥−3). & \end{aligned}
...
\begin{aligned}\frac{4(2𝑥−3)}{2} & = \\ \frac{2⋅2⋅(2𝑥−3)}{2} & = \\ \frac{2⋅2⋅(2𝑥−3)}{2} & = \\ \frac{2⋅(2𝑥−3)}{1} & = \\ 2(2𝑥−3). & \end{aligned}
...
\begin{aligned}\frac{20}{8(𝑧−1)}=\frac{2⋅2⋅5}{2⋅2⋅2⋅(𝑧−1)}\end{aligned}
...
\begin{aligned}\frac{2⋅2⋅5}{2⋅2⋅2⋅(𝑧−1)} & = \\ \frac{2⋅2⋅5}{2⋅2⋅2⋅(𝑧−1)} & = \\ \frac{5}{2⋅(𝑧−1)} & = \\ \frac{5}{2(𝑧−1)} & \end{aligned}
...
### Example: Simplifying Rational Expressions with Common Variable Factors
...
\begin{aligned}\frac{3𝑦}{𝑦(𝑦+1)}=\frac{3⋅𝑦}{𝑦⋅(𝑦+1)}\end{aligned}
...
\begin{aligned}\frac{3⋅𝑦}{𝑦⋅(𝑦+1)} & = \\ \frac{3⋅𝑦}{𝑦⋅(𝑦+1)} & = \\ \frac{3}{𝑦+1} & \end{aligned}
...
### Example: Simplifying Rational Expressions with Common Monomial Factors
...
\begin{aligned}\frac{6𝑦(𝑥−2)}{9𝑦𝑧}=\frac{2⋅3⋅𝑦⋅(𝑥−2)}{3⋅3⋅𝑦⋅𝑧}\end{aligned}
...
\begin{aligned}\frac{2⋅3⋅𝑦⋅(𝑥−2)}{3⋅3⋅𝑦⋅𝑧} & = \\ \frac{2⋅3⋅𝑦⋅(𝑥−2)}{3⋅3⋅𝑦⋅𝑧} & = \\ \frac{2⋅(𝑥−2)}{3𝑧} & = \\ \frac{2(𝑥−2)}{3𝑧} & \end{aligned}
...
### Example: Simplifying Rational Expressions with Common Binomial Factors
...
\begin{aligned}\frac{6𝑎(𝑐+1)}{3𝑏(𝑐+1)}=\frac{2⋅3⋅𝑎⋅(𝑐+1)}{3⋅𝑏⋅(𝑐+1)}\end{aligned}
...
\begin{aligned}\frac{2⋅3⋅𝑎⋅(𝑐+1)}{3⋅𝑏⋅(𝑐+1)} & = \\ \frac{2⋅3⋅𝑎⋅(𝑐+1)}{3⋅𝑏⋅(𝑐+1)} & = \\ \frac{2⋅𝑎}{𝑏} & = \\ \frac{2𝑎}{𝑏} & \end{aligned}
