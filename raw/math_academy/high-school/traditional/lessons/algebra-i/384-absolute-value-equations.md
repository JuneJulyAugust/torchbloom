...
Source: https://www.mathacademy.com/topics/384?courseId=44
Topic ID: 384
...
- [Distributing the Negative Sign in a Linear Expression](../../../../middle-school/lessons/prealgebra/137-distributing-the-negative-sign-in-a-linear-expression.md)
...
- Substituting $x={\color{blue}3}$ into our equation, we get Therefore, $x={\color{blue}3}$ is indeed a solution to the absolute value equation.

- Substituting $x={\color{red}-5}$ into our equation, we get Therefore, $x={\color{red}-5}$ is indeed a solution to the absolute value equation.

Therefore, $x={\color{blue}3}$ and $x={\color{red}{-5}}$ are both solutions to our absolute value equation.

### Example: Solving One-Step Absolute Value Equations
...
- If $\left| \dfrac{7}{2}z-2 \right| = \dfrac{7}{2}z-2,$ we obtain: Multiplying both sides of the equation by $\dfrac{2}{7}$ gives

- If $\left| \dfrac{7}{2}z-2 \right| = -\left(\dfrac{7}{2}z-2\right),$ we obtain: Multiplying both sides of the equation by $-\dfrac{2}{7}$ gives
