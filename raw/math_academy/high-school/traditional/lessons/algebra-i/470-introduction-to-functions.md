...
Source: https://www.mathacademy.com/topics/470?courseId=44
Topic ID: 470

## Prerequisites

- [Evaluating Linear Expressions](../../../../middle-school/lessons/prealgebra/64-evaluating-linear-expressions.md)
- [Evaluating Numerical Expressions Containing Radicals](../../../../middle-school/lessons/prealgebra/589-evaluating-numerical-expressions-containing-radicals.md)
...
### Example: Evaluating a Multivariable Function
...
\begin{aligned}𝑓(𝑥,𝑦) & =3⋅2^{𝑥+3𝑦} \\ 𝑓(4,−1) & =3⋅2^{4+3(−1)} \\ & =3⋅2^{4−3} \\ & =3⋅2^{1} \\ & =3⋅2 \\ & =6\end{aligned}
