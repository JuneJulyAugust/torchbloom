...
Source: https://www.mathacademy.com/topics/655?courseId=44
Topic ID: 655
...
### Example: Identifying Polynomial Terms
...
- Expression I is ** a polynomial term since $5\sqrt x = 5x^{1/2}.$ Here, $x$ is raised the power of $1/2,$ which is not an integer.
...
- Expression III is ** a polynomial because $\dfrac 2 {x^2} = 2x^{-2}.$ Here, $x$ is raised the power of $-2,$ which is negative.
...
### Example: Identifying Polynomials
...
- Expression III is ** a polynomial because $3\sqrt{x}$ is not a polynomial term. It is equivalent to $3x^{1/2},$ in which case the exponent on the variable is not an integer.
...
\begin{aligned}2𝑥^{2}+3 & = \\ 2(5)^{2}+3 & = \\ 2(25)+3 & = \\ 50+3 & = \\ 53 & \end{aligned}
...
\begin{aligned}𝑥^{3}+4𝑥^{2}−3 & = \\ (−1)^{3}+4(−1)^{2}−3 & = \\ −1+4(1)−3 & = \\ −1+4−3 & = \\ 0 & \end{aligned}


$$

### Example: Evaluating a Polynomial Using Function Notation
...
\begin{aligned}𝑓(𝑥) & =4𝑥^{2}−5𝑥 \\ 𝑓(−2) & =4(−2)^{2}−5(−2) \\ & =16+10 \\ & =26\end{aligned}
