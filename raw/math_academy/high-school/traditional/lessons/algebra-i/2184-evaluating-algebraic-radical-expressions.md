...
Source: https://www.mathacademy.com/topics/2184?courseId=44
Topic ID: 2184
...
### Example: Evaluating a Radical Expression that Simplifies to a Whole Number
...
\begin{aligned}\sqrt[√𝑥+6]{3} & = \\ \sqrt[√2+6]{3} & = \\ \sqrt[√8]{3} & = \\ \sqrt[√2^{3}]{3} & = \\ 2 & \end{aligned}
