...
Source: https://www.mathacademy.com/topics/2076?courseId=101
Topic ID: 2076
...
- [Further Graphing of Two-Variable Linear Inequalities](../../../traditional/lessons/algebra-i/3822-further-graphing-of-two-variable-linear-inequalities.md)
...
![Instructional graphic](../../../../lesson-assets/integrated-math-iii-honors/topic-2076/b17577def66ea345.png)

Our task now is to determine the sign of $f(x,y)$ in each region. To do this, we pick four test points, one for each region.

![Instructional graphic](../../../../lesson-assets/integrated-math-iii-honors/topic-2076/41db352c8abbf246.png)
...
![Instructional graphic](../../../../lesson-assets/integrated-math-iii-honors/topic-2076/f436e6cf35fb0e4a.png)
...
![Instructional graphic](../../../../lesson-assets/integrated-math-iii-honors/topic-2076/0e880282655f90ab.png)

To determine the sign of $f(x,y)$ in each region, we pick four test points, one for each region.

![Instructional graphic](../../../../lesson-assets/integrated-math-iii-honors/topic-2076/dad8830f7a5e8a54.png)
...
![Instructional graphic](../../../../lesson-assets/integrated-math-iii-honors/topic-2076/f2505c1722d59aa7.png)
...
![Instructional graphic](../../../../lesson-assets/integrated-math-iii-honors/topic-2076/99e47976fade9e93.png)

To determine the sign of $f(x,y)$ in each region, we pick four test points, one for each region.

![Instructional graphic](../../../../lesson-assets/integrated-math-iii-honors/topic-2076/1001f723de8953bd.png)

Next, we calculate the sign of $f(x,y)$ in each region using a sign table:

Finally, on our diagram, we shade in the solutions to $f(x,y) \geq 0$ using the ** column of the table above.

![Instructional graphic](../../../../lesson-assets/integrated-math-iii-honors/topic-2076/876191748f813687.png)
