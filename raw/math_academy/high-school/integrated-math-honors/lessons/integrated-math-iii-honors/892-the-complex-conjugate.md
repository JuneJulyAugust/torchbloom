...
Source: https://www.mathacademy.com/topics/892?courseId=101
Topic ID: 892
...
### Example: Finding the Complex Conjugate of a Complex Number With Positive Imaginary Part
...
### Example: Finding the Complex Conjugate of a Real Number

#### Question

What is the complex conjugate of $z=-6?$

#### Explanation

The number $z=-6$ is a real number, and the complex conjugate of any real number is just the number itself.

So here, the complex conjugate is $\overline{z} = z = -6.$
