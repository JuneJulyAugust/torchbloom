...
Source: https://www.mathacademy.com/topics/3658?courseId=128
Topic ID: 3658

## Prerequisites

- [Tree Diagrams for Dependent Events](../../../traditional/lessons/geometry/739-tree-diagrams-for-dependent-events.md)
...
![Instructional graphic](../../../../lesson-assets/integrated-math-ii-honors/topic-3658/28cbf2eefaa886f8.png)
...
![Instructional graphic](../../../../lesson-assets/integrated-math-ii-honors/topic-3658/55d44c417a18ca34.png)

To calculate the probability that Alice will be late on a randomly selected day, we first highlight the relevant branches.

![Instructional graphic](../../../../lesson-assets/integrated-math-ii-honors/topic-3658/40d4a40f427d8aa2.png)
...
![Instructional graphic](../../../../lesson-assets/integrated-math-ii-honors/topic-3658/682b22e56c585333.png)

To compute $P(\text{Odd} \cap \text{Odd}),$ we multiply the probabilities across the appropriate branches, shown below:

![Instructional graphic](../../../../lesson-assets/integrated-math-ii-honors/topic-3658/fc15ae28f7e6d3c3.png)
...
![Instructional graphic](../../../../lesson-assets/integrated-math-ii-honors/topic-3658/383b5eca6236de78.png)

The possible outcomes that give two balls of different colors are highlighted below.

![Instructional graphic](../../../../lesson-assets/integrated-math-ii-honors/topic-3658/2a7f518830e37168.png)
