...
Source: https://www.mathacademy.com/topics/30?courseId=128
Topic ID: 30

## Prerequisites

- [The Quotient Rule for Logarithms](../../../traditional/lessons/algebra-ii/1474-the-quotient-rule-for-logarithms.md)
- [The Power Rule for Logarithms](../../../traditional/lessons/algebra-ii/1475-the-power-rule-for-logarithms.md)
...
\begin{aligned} 3\log_2(x) + \dfrac 1 2 \log_2(y) &= \log_2\left(x^3\right) + \log_2\left(y^{1/ 2}\right)\\&= \log_2\left(x^3\right) + \log_2 \left(\sqrt{y}\right) . \end{aligned}
