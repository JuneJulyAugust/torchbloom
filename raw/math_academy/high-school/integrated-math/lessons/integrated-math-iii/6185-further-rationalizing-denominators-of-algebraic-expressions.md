...
Source: https://www.mathacademy.com/topics/6185?courseId=134
Topic ID: 6185

## Prerequisites

- [Rationalizing Denominators With Two Terms](../../../traditional/lessons/algebra-i/86-rationalizing-denominators-with-two-terms.md)
- [Rationalizing Denominators of Algebraic Expressions](../../../traditional/lessons/algebra-i/599-rationalizing-denominators-of-algebraic-expressions.md)
...
Rationalize the denominator of $\dfrac{1}{3-\sqrt a}.$
...
### Example: Rationalizing Denominators Containing a Binomial Within the Radical

#### Question

Rationalize the denominator of $\dfrac {x} {\sqrt{x+1}+1}.$
...
### Example: Rationalizing a Denominator With Two Radicals

#### Question

Rationalize the denominator of $\dfrac{x}{\sqrt{2}-\sqrt{x}}.$
