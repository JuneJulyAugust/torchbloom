...
Source: https://www.mathacademy.com/topics/1720?courseId=43
Topic ID: 1720
...
![Instructional graphic](../../lesson-assets/precalculus/topic-1720/4be536a4b6590bf4.png)

1. $f(x)$ continues increasing without bound toward $\infty.$ In this case, we write $f(x)\to \infty$ as $x\to\infty.$

![Instructional graphic](../../lesson-assets/precalculus/topic-1720/aac2f8360c1ea647.png)

1. $f(x)$ continues decreasing without bound toward $-\infty.$ In this case, we write $f(x)\to -\infty$ as $x\to\infty.$

![Instructional graphic](../../lesson-assets/precalculus/topic-1720/c6f706f16a78386d.png)
