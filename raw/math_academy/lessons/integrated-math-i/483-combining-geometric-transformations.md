...
Source: https://www.mathacademy.com/topics/483?courseId=132
Topic ID: 483

## Prerequisites

- [Dilations of Figures in the Coordinate Plane](../geometry/577-dilations-of-figures-in-the-coordinate-plane.md)
- [Combining Stretches of Geometric Figures](../geometry/1363-combining-stretches-of-geometric-figures.md)
- [Rotating Objects in the Coordinate Plane Using Functions](../geometry/3823-rotating-objects-in-the-coordinate-plane-using-functions.md)
...
![Instructional graphic](../../lesson-assets/integrated-math-i/topic-483/9ba60f0560ec100f.png)
...
![Instructional graphic](../../lesson-assets/integrated-math-i/topic-483/77d0b49485654f2b.png)

- Next, we take $\overline{A'B'}$ and shift it by $3$ units down. This gives the segment $\overline{A''B''}\mathbin{:}$

![Instructional graphic](../../lesson-assets/integrated-math-i/topic-483/ccb04905bca0279c.png)
...
![Instructional graphic](../../lesson-assets/integrated-math-i/topic-483/330de797c1c4a620.png)
...
![Instructional graphic](../../lesson-assets/integrated-math-i/topic-483/33a3df1c0ead28de.png)

- Reflecting the point $A$ in the $x$-axis gives the point $D,$ as shown below:

![Instructional graphic](../../lesson-assets/integrated-math-i/topic-483/9ee3dbecd9acf93b.png)
...
![Instructional graphic](../../lesson-assets/integrated-math-i/topic-483/ebb11c85432a927e.png)
...
![Instructional graphic](../../lesson-assets/integrated-math-i/topic-483/8a3dc5bd88912f79.png)

- Next, we take the last result and reflect it across the $x$-axis.

![Instructional graphic](../../lesson-assets/integrated-math-i/topic-483/3236e8f586d6959d.png)
