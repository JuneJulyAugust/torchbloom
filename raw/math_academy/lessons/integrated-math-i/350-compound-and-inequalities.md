...
Source: https://www.mathacademy.com/topics/350?courseId=132
Topic ID: 350
...
![Instructional graphic](../../lesson-assets/integrated-math-i/topic-350/4a26207dd2171f11.png)

To find the values of $x$ that satisfy both inequalities, we find where the two solutions overlap:

![Instructional graphic](../../lesson-assets/integrated-math-i/topic-350/cc6bad2444093294.png)
...
![Instructional graphic](../../lesson-assets/integrated-math-i/topic-350/91ebe5c0caf0ccf6.png)

- Then, we solve $7x +11 < -3$:

![Instructional graphic](../../lesson-assets/integrated-math-i/topic-350/17c40148e22a40c0.png)

To find the values of $x$ that satisfy both inequalities, we find where the two solutions overlap:

![Instructional graphic](../../lesson-assets/integrated-math-i/topic-350/235fe443ddbcfa2e.png)
...
![Instructional graphic](../../lesson-assets/integrated-math-i/topic-350/61466bf97df6cc3b.png)

- Then, we solve $7x > 21\mathbin{:}$

![Instructional graphic](../../lesson-assets/integrated-math-i/topic-350/d8c169aa6237cc6d.png)

To find the values of $x$ that satisfy both inequalities, we find where the two solutions overlap:

![Instructional graphic](../../lesson-assets/integrated-math-i/topic-350/50ceb0143a368c1a.png)
...
![Instructional graphic](../../lesson-assets/integrated-math-i/topic-350/e421e66014a31c14.png)

- Then, we solve $10x-3 \geq 7\mathbin{:}$

![Instructional graphic](../../lesson-assets/integrated-math-i/topic-350/1dec02e7ca9f8f6d.png)

To find the values of $x$ that satisfy both inequalities, we find where the two solutions overlap:

![Instructional graphic](../../lesson-assets/integrated-math-i/topic-350/1d1614bc30516a8d.png)
...
![Instructional graphic](../../lesson-assets/integrated-math-i/topic-350/77843a3537f7821f.png)

- Then, we solve $2-3x \leq -4 \,\mathbin{:}$

![Instructional graphic](../../lesson-assets/integrated-math-i/topic-350/885e8f3635f62484.png)

To find the values of $x$ that satisfy both inequalities, we find where the two solutions overlap:

![Instructional graphic](../../lesson-assets/integrated-math-i/topic-350/4392a12e54c8dc1f.png)
