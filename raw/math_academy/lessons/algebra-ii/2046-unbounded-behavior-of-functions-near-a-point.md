...
Source: https://www.mathacademy.com/topics/2046?courseId=51
Topic ID: 2046
...
![Instructional graphic](../../lesson-assets/algebra-ii/topic-2046/67f6f5f724f4621e.png)

As the input $x$ gets closer to $1,$ the values of the function get larger and larger.

![Instructional graphic](../../lesson-assets/algebra-ii/topic-2046/90fd4d4ac9d67536.png)
...
![Instructional graphic](../../lesson-assets/algebra-ii/topic-2046/f9facc4ba974f1a1.png)
...
![Instructional graphic](../../lesson-assets/algebra-ii/topic-2046/83b3c2b3b17b518f.png)
...
![Instructional graphic](../../lesson-assets/algebra-ii/topic-2046/829b9d2b6b6a8ceb.png)
...
![Instructional graphic](../../lesson-assets/algebra-ii/topic-2046/d0709da21afa3fc2.png)
...
![Instructional graphic](../../lesson-assets/algebra-ii/topic-2046/5634b05eea61dbe2.png)

#### Explanation

From the given graph, we see that as $x$ approaches $2,$ the values of $f(x)$ increase, approaching $\infty.$

![Instructional graphic](../../lesson-assets/algebra-ii/topic-2046/e649105b0bd40d07.png)
...
![Instructional graphic](../../lesson-assets/algebra-ii/topic-2046/ded360d1aaac9282.png)
...
![Instructional graphic](../../lesson-assets/algebra-ii/topic-2046/1e90dbe5d592334a.png)
...
![Instructional graphic](../../lesson-assets/algebra-ii/topic-2046/5991e9c5b323984d.png)
...
![Instructional graphic](../../lesson-assets/algebra-ii/topic-2046/9479faa54b5a3b87.png)
...
![Instructional graphic](../../lesson-assets/algebra-ii/topic-2046/5a92998783c5c3e5.png)
...
![Instructional graphic](../../lesson-assets/algebra-ii/topic-2046/983d91263b656514.png)

#### Explanation

Recall that $x = a$ is called a vertical asymptote of $y = f(x)$ if $f(x) \to \pm \infty$ as $x \to a^+$ or $x \to a^-.$

![Instructional graphic](../../lesson-assets/algebra-ii/topic-2046/1ea16b0d54f64533.png)
