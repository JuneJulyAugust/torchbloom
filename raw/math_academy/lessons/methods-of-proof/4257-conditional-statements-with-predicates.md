...
Source: https://www.mathacademy.com/topics/4257?courseId=76
Topic ID: 4257
...
![Instructional graphic](../../lesson-assets/methods-of-proof/topic-4257/871fe5cd40d3e9f2.png)
...
![Instructional graphic](../../lesson-assets/methods-of-proof/topic-4257/206a77b5de2b4fb8.png)

Therefore, to get the truth set of $\neg P(x) \lor Q(x),$ we take all the points that belong to $\overline{T}_p$ or $T_Q{:}$

![Instructional graphic](../../lesson-assets/methods-of-proof/topic-4257/5df8cfa32394b982.png)

As a result, we get the following diagram:

![Instructional graphic](../../lesson-assets/methods-of-proof/topic-4257/01bdefe7431995ca.png)
