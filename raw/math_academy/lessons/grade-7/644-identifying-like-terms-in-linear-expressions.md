...
Source: https://www.mathacademy.com/topics/644?courseId=37
Topic ID: 644
...
In some expressions, there are no like terms. For example, in the expression
...
there are two terms, $a$ and $2b$. These two terms do not have the same variable part, so they are not like terms.

### Example: Identifying Like Terms when there are No Like Terms
...
### Example: Identifying Constants as Like Terms

#### Question

What are the like terms of the expression $4 + 0.8p - 2.3p - 3.2p + 10?$
