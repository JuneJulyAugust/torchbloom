...
Source: https://www.mathacademy.com/topics/3899?courseId=75
Topic ID: 3899
...
The key is to determine the place value of each part of the number. So, we first break down our number as follows:
...
### Example: Reading a Number Written in Words Up to Three Digits

#### Question

How is "five hundred thirty-two" written using digits?
...
### Example: Reading a Number Written in Words Up to Six Digits

#### Question

How is "four hundred one thousand, twenty" written using digits?
...
### Example: Reading a Number Written in Words Up to Eight Digits

#### Question

How is "thirty-nine million, one hundred one thousand, two" written using digits?
