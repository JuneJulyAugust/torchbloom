...
Source: https://www.mathacademy.com/topics/3953?courseId=75
Topic ID: 3953
...
$$
\begin{aligned}5+(3×7) & = \\ 5+21 & = \\ 26 & \end{aligned}
$$
...
$$
\begin{aligned}(5+3)×7 & = \\ 8×7 & = \\ 56 & \,×\end{aligned}
$$

which is *incorrect!*

### Example: Evaluating Expressions Where Multiplication Comes First
...
$$
\begin{aligned}(5×4)−7 & = \\ 20−7 & = \\ 13 & .\end{aligned}
$$
...
$$
\begin{aligned}4+(10×2) & = \\ 4+20 & = \\ 24 & .\end{aligned}
$$
...
$$
3 \times 9 - 2 \times 5 = ({\color{blue}3 \times 9}) - ({\color{red}2 \times 5})
$$

Now, we evaluate the products:

$$
\begin{aligned}3×9 & =27 \\ 2×5 & =10\end{aligned}
$$

Therefore,

$$
\begin{aligned}(3×9)−(2×5) & = \\ 27−10 & = \\ 17 & .\end{aligned}
$$
