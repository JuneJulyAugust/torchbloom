...
Source: https://www.mathacademy.com/topics/3874?courseId=75
Topic ID: 3874
...
- Firstly, this equation tells us that "*$8$ is ${\color{red}{2}}$ **** than ${\color{blue}{4}}.$*" This is because we need to add ${\color{red}{2}}$ copies of ${\color{blue}{4}}$ to make $8{:}$

- Secondly, this equation tells us that "*$8$ is ${\color{blue}{4}}$ **** than ${\color{red}{2}}.$*" This is because we need to add ${\color{blue}{4}}$ copies of ${\color{red}{2}}$ to make $8{:}$

Every multiplication problem can be expressed as two separate comparison statements.

### Example: Multiplication Problems as Comparison Statements
...
- Firstly, this equation tells us that "*$9$ is ${\color{blue}{2}}$ **** ${\color{red}{7}}.$*" This is because we need to add an additional ${\color{blue}{2}}$ to ${\color{red}{7}}$ to make $9.$

- Secondly, this equation tells us that "*$9$ is ${\color{red}{7}}$ **** ${\color{blue}{2}}.$*" This is because we need to add an additional ${\color{red}{7}}$ to ${\color{blue}{2}}$ to make $9.$
...
### Example: Distinguishing Between Multiplicative and Additive Comparison
...
**** The word "times" is important. The following answer is **** correct.
