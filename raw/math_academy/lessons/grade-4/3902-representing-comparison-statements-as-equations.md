...
Source: https://www.mathacademy.com/topics/3902?courseId=75
Topic ID: 3902
...
$\qquad$ *$20$ is ${\color{red}{5}}$ **** ${\color{blue}{15}}$*
...
### Example: Writing an Additive Comparison as an Equation

#### Question

Which of the following equations shows that $12$ is $8$ smaller than $20?$
...
$\qquad$ *$20$ is ${\color{red}{5}}$ **** ${\color{blue}{4}}$*

Note the following:

- The word "times" *is* present. Therefore, this is a *multiplicative* comparison.

- The statement tells us that we must add ${\color{red}{5}}$ copies of ${\color{blue}{4}}$ to make $20.$ This gives Since multiplication is repeated addition, we can write this equation as follows:
...
### Example: Writing a Multiplicative Comparison as an Equation

#### Question

Which of the following equations shows that $56$ is $8$ times larger than $7?$
...
$\qquad$ *Which number is $3$ **** than $4?$*
...
### Example: Finding an Unknown Product

#### Question

What number is $9$ times larger than $8?$
...
So, the statement compares the size of a ** $({\color{blue}{n}})$ to its ** $(8$ and $9).$ Here, the letter ${\color{blue}{n}}$ represents the unknown product.
...
### Example: Finding an Unknown Factor
...
So, the statement compares the size of a ** $(72)$ to its ** $9,$ and ${\color{blue}{n}}.$ Here, ${\color{blue}{n}}$ represents the unknown second factor.
