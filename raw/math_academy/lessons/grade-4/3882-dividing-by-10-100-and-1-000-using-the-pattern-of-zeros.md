...
Source: https://www.mathacademy.com/topics/3882?courseId=75
Topic ID: 3882
...
$$
520 \div 10 = 52\!\cancel{0} = 52.
$$

**Watch Out!** This method only works for *whole numbers* that end in at least one zero.

### Example: Dividing Whole Numbers by Ten

#### Question

Find the value of $3,500 \div 10.$
...
$$
\begin{aligned}3,500÷10 & = \\ 3,50\,0 & = \\ 350 & \end{aligned}
$$

### Example: Dividing Whole Numbers by Ten: Word Problems
...
$$
\begin{aligned}1,600÷10 & = \\ 1,60\,0 & = \\ 160 & \end{aligned}
$$
...
$$
6,500 \div 100 = 6,5\!\cancel{00} = 65.
$$
...
$$
32,000 \div 1,000 = 32,\!\!\cancel{000} = 32.
$$

This method only works for whole numbers that end in at least *three* zeros.

### Example: Dividing Whole Numbers by One Hundred

#### Question

Due to the rupture of a pipe that supplies water to a small town, $28,000$ liters of water were lost over a period of $100$ minutes. How much water was lost every minute?

#### Explanation

To determine how much water was lost each minute, we must calculate the value of $28,000 \div 100.$

Notice that the dividend $(28,000)$ is a whole number ending in ** zeros.

To divide a whole number ending in two zeros by $100,$ we remove the final two zeros as follows:

$$
\begin{aligned}28,000÷100 & = \\ 28,0\,00 & = \\ 280 & \end{aligned}
$$

Therefore, $280$ liters of water was lost every minute.

### Example: Dividing Whole Numbers by One Thousand
...
Notice that the dividend $(450,000)$ is a whole number ending in ** zeros.

To divide a whole number ending in three zeros by $1,000,$ we remove the final three zeros as follows:

$$
\begin{aligned}450,000÷1,000 & = \\ 450,\,\,000 & = \\ 450 & \end{aligned}
$$
