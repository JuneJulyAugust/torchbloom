...
\boxed{2} \times \boxed{6} = {\color{red}{12}}
...
Michael bought thirteen T-shirts for his children. The T-shirts cost $17$ each. By rounding the number of T-shirts and the cost of each shirt to the nearest ten, estimate the total amount that Michael paid for the T-shirts.
...
\boxed{1} \times \boxed{2} = \color{red}{2}
...
Therefore, Michael paid approximately $200$ for the T-shirts.
...
![Instructional graphic](../../lesson-assets/grade-4/topic-2287/2a7af14ed3aeeec0.png)
...
\boxed{7} \times \boxed{4} = \color{red}{28}
...
\boxed{2} \times \boxed{8} = \color{red}{16}
...
\boxed{4} \times \boxed{4} = \color{red}{16}
