...
Source: https://www.mathacademy.com/topics/2364?courseId=75
Topic ID: 2364
...
### Example: Cases Where the Numerator or Denominator Is a One-Digit Number

#### Question

What is $\dfrac{8}{32}$ written in lowest terms?
...
### Example: Cases Where the Numerator and Denominator Are Two-Digit Numbers
...
### Example: Identifying Fractions in Lowest Terms
...
- The fraction $\dfrac{10}{15}$ is **** written in lowest terms. Notice that the greatest common factor of $10$ and $15$ is $5.$ So, we can divide both the numerator and denominator by $5.$
