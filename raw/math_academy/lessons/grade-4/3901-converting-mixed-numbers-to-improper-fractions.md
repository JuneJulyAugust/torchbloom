...
Source: https://www.mathacademy.com/topics/3901?courseId=75
Topic ID: 3901
...
$$
\begin{aligned}2\,\frac{1}{3} & = \\ 2+\frac{1}{3} & = \\ \frac{6}{3}+\frac{1}{3} & = \\ \frac{6+1}{3} & = \\ \frac{7}{3} & \end{aligned}
$$

Therefore, $2\,\dfrac13$ expressed as an improper fraction is $\dfrac73.$

### Example: Converting to an Improper Fraction Given the Whole Number Representation
...
$$
\begin{aligned}5+\frac{1}{6}=\frac{30}{6}+\frac{1}{6}=\frac{31}{6}.\end{aligned}
$$
...
$$
\begin{aligned}5\,\frac{3}{4}=\frac{20}{4}+\frac{3}{4}=\frac{23}{4}\end{aligned}
$$
