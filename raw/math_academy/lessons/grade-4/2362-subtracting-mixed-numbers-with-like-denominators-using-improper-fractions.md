...
Source: https://www.mathacademy.com/topics/2362?courseId=75
Topic ID: 2362

## Prerequisites

- [Subtracting Mixed Numbers With Like Denominators](https://www.mathacademy.com/topics/subtracting-mixed-numbers-with-like-denominators-235)
...
$$
\begin{aligned}4\,\frac{1}{3}−3\,\frac{2}{3} & =\frac{13}{3}−\frac{11}{3} \\ & =\frac{13−11}{3} \\ & =\frac{2}{3}\end{aligned}
$$
...
However, we ** perform this subtraction because $\dfrac49$ is larger than $\dfrac29.$
...
However, we ** perform this subtraction because $\dfrac{4}{6}$ is larger than $\dfrac{2}{6}.$
...
Finally, we can simplify $\dfrac{4}{6}$ by dividing the numerator and denominator by $2{:}$
...
$$
\begin{aligned}\frac{14}{5} & =14÷5 \\ & =2\,R\,4 \\ & =2\,\frac{4}{5}\end{aligned}
$$
...
### Example: Subtracting Mixed Numbers When the Difference of the Fractional Parts Gives a Whole
...
However, we ** perform this subtraction because $\dfrac34$ is larger than $\dfrac14.$
...
We can simplify $\dfrac{18}{4}$ by dividing the numerator and denominator by $2{:}$
