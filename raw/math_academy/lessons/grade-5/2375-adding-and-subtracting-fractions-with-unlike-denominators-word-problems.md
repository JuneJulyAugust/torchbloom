...
Source: https://www.mathacademy.com/topics/2375?courseId=30
Topic ID: 2375
...
For example, suppose William went to the grocery store to buy flour. He purchased $\dfrac{1}{3}$ pounds of brown flour and $\dfrac{1}{6}$ pounds of white flour. He'd like to know how much flour he bought in total.
...
To find the length of the original slat, we need to calculate the sum $\dfrac{6}{5} + \dfrac{7}{4}.$
...
John spends $\dfrac{5}{4}$ of an hour in the gym. During this time, he's either on the exercise bike or lifting weights. One day, he spent $\dfrac{1}{2}$ on the exercise bike. How much time did John spend lifting weights?
...
### Example: Subtracting Fractions When Neither Denominator Is a Multiple of the Other
...
To determine the length of the other piece, we need to calculate the difference $\dfrac{9}{4} - \dfrac{15}{14}.$
