...
Source: https://www.mathacademy.com/topics/2290?courseId=30
Topic ID: 2290
...
### Example: Rounding With One Decimal Place

#### Question

By rounding each factor to the nearest whole number, estimate the product $7.7 \times 5.2.$
...
### Example: Rounding With Two Decimal Places

#### Question

By rounding each factor to the nearest whole number, estimate the product $6.15 \times 8.64.$
