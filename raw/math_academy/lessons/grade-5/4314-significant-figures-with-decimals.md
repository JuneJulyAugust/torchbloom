...
Source: https://www.mathacademy.com/topics/4314?courseId=30
Topic ID: 4314
...
### Example: Identifying Significant Figures With Decimals

#### Question

Find the first three significant figures of $6.047\,125.$
...
- **Step 3:** Finally, we change digits to the bar's right to zeros: This gives the number $2.700,$ which is equivalent to $2.7.$

Therefore, $2.714$ rounded to two significant figures is $2.7.$

Let's now look at an example where we need to round *up*.

### Example: Rounding a Decimal With a Whole Number Part

#### Question

Round the number $45.363$ to three significant figures.
...
### Example: Rounding a Decimal With No Whole Number Part

#### Question

What is $0.023\,94$ rounded to three significant figures?
...
### Example: Rounding a Number With The Digit Nine

#### Question

What is $14.963$ rounded to three significant figures?
