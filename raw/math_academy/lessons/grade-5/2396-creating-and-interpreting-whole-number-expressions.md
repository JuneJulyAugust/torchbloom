...
Source: https://www.mathacademy.com/topics/2396?courseId=30
Topic ID: 2396
...
### Example: Writing an Expression in Words

#### Question

What phrase represents the expression $(9 - 7) \times 2?$

#### Explanation

Since the expression uses parentheses, this operation comes first. So first, we should "**".

The $\times\,2$ means that we should "**".
...
What expression represents the phrase "**"?

#### Explanation

Checking our phrase carefully, we need to subtract $5$ from $7$ ** multiplying by $2.$
...
### Example: Using Double, Triple, and Quadruple
...
Two children, Charlie and Maria, have $3$ dogs and $2$ cats each. Write an expression represents the total number of pets that they have?
