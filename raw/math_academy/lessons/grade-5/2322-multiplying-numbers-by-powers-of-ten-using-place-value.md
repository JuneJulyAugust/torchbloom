...
Source: https://www.mathacademy.com/topics/2322?courseId=30
Topic ID: 2322
...
**** We write down the place value chart for $232$:

**** Since we're multiplying by $10,$ we move all digits to the left by $1$ place and place a zero in the empty cell on the right.
...
**** We write down the place value chart for $67$:

**** Since $1{\color{blue}{00}}$ contains a block of $\color{blue}2$ zeros, we move all values to the left by $2$ places and place zeros in the empty cells on the right.
...
**** We write down the place value chart for $15$:

**** Notice that $1,{\color{blue}000}$ contains a block of $3$ zeros. So, we move all digits to the left by $3$ places and place zeros in the empty cells on the right.
