...
Source: https://www.mathacademy.com/topics/4135?courseId=54
Topic ID: 4135

## Prerequisites

- [Polar Equations of Radial Lines](../integrated-math-iii-honors/2173-polar-equations-of-radial-lines.md)
...
![Instructional graphic](../../lesson-assets/multivariable-calculus/topic-4135/dc510e0ad86b8c7a.png)
...
![Instructional graphic](../../lesson-assets/multivariable-calculus/topic-4135/94c957c99de01076.png)
...
![Instructional graphic](../../lesson-assets/multivariable-calculus/topic-4135/d354d5c658f2d942.png)
...
![Instructional graphic](../../lesson-assets/multivariable-calculus/topic-4135/2040407cf5686865.png)

- Similarly, we can find the image of the top side, where $v=\dfrac{2\pi}{5}$ and $1 \leq u \leq 2.$

![Instructional graphic](../../lesson-assets/multivariable-calculus/topic-4135/923f4699af9a4ed3.png)

### Finding the Image of a Vertical Segment

![Instructional graphic](../../lesson-assets/multivariable-calculus/topic-4135/6d7b697d2f5acbc1.png)
...
![Instructional graphic](../../lesson-assets/multivariable-calculus/topic-4135/64a39e05e00fd85f.png)

- Similarly, we can find the image of the right side, where we have $u=2$ and $\dfrac{\pi}{6} \leq v \leq \dfrac{2\pi}{5}.$

![Instructional graphic](../../lesson-assets/multivariable-calculus/topic-4135/76df23cab15c7dcf.png)
...
![Instructional graphic](../../lesson-assets/multivariable-calculus/topic-4135/f35fcbcaae909793.png)

### Example: Finding the Image of a Vertical Segment Under a Polar Transformation

#### Question

![Instructional graphic](../../lesson-assets/multivariable-calculus/topic-4135/6442ca4f1a1a71fa.png)
...
![Instructional graphic](../../lesson-assets/multivariable-calculus/topic-4135/45e48f6db241c4ce.png)

### Example: Finding the Image of a Horizontal Segment Under a Polar Transformation

#### Question

![Instructional graphic](../../lesson-assets/multivariable-calculus/topic-4135/aafdcdffd1c6b72e.png)
...
![Instructional graphic](../../lesson-assets/multivariable-calculus/topic-4135/43d006fb953984b3.png)

### Example: Finding the Image of a Rectangle Under a Polar Transformation

#### Question

![Instructional graphic](../../lesson-assets/multivariable-calculus/topic-4135/cd3d554b3e5937ba.png)
...
![Instructional graphic](../../lesson-assets/multivariable-calculus/topic-4135/0bc1508db4ee8019.png)
...
![Instructional graphic](../../lesson-assets/multivariable-calculus/topic-4135/49e15af47d17b0b3.png)
...
![Instructional graphic](../../lesson-assets/multivariable-calculus/topic-4135/de89f770ea06dbc7.png)
