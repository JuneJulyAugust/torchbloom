...
Source: https://www.mathacademy.com/topics/1894?courseId=54
Topic ID: 1894
...
![Instructional graphic](../../lesson-assets/multivariable-calculus/topic-1894/2ec876bb4661b71a.png)
...
![Instructional graphic](../../lesson-assets/multivariable-calculus/topic-1894/db0ba73ef480ebdc.png)
...
![Instructional graphic](../../lesson-assets/multivariable-calculus/topic-1894/620823d3a4e2ff9a.png)
...
![Instructional graphic](../../lesson-assets/multivariable-calculus/topic-1894/a9123a126a51a4cd.png)

There are a few other cases we should note:

- The trace of our surface with the plane $z=k$ for $k \neq 0$ is an ellipse:

![Instructional graphic](../../lesson-assets/multivariable-calculus/topic-1894/afdedd220046225f.png)

- The traces of our surface with the plane $x=k$ or $y=k$ for $k \neq 0$ are hyperbolas:

![Instructional graphic](../../lesson-assets/multivariable-calculus/topic-1894/242cb379117e3f8a.png)
...
![Instructional graphic](../../lesson-assets/multivariable-calculus/topic-1894/1a99a7ff5943fd23.png)

- When the $x^2$ term is isolated on one side, the axis of symmetry is the $x$-axis.

![Instructional graphic](../../lesson-assets/multivariable-calculus/topic-1894/6465cceba985a9eb.png)
