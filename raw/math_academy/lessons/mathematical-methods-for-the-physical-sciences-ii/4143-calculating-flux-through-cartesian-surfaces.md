...
Source: https://www.mathacademy.com/topics/4143?courseId=155
Topic ID: 4143
...
\begin{aligned}𝐫_{′𝑢}^{}×𝐫_{′𝑣}^{} & =\begin{aligned}𝐢 & 𝐣 & 𝐤 \\ 1 & 0 & −2 \\ 0 & 1 & 2\end{aligned} \\ & =⟨\begin{aligned}0 & −2 \\ 1 & 2\end{aligned},\,−\begin{aligned}1 & −2 \\ 0 & 2\end{aligned},\,\begin{aligned}1 & 0 \\ 0 & 1\end{aligned}⟩ \\ & =⟨2,\,−2,\,1⟩.\end{aligned}
...
\begin{aligned}𝐫_{′𝑢}^{}×𝐫_{′𝑣}^{} & =\begin{aligned}𝐢 & 𝐣 & 𝐤 \\ 1 & 0 & −3 \\ 0 & 1 & 2\end{aligned} \\ & =⟨\begin{aligned}0 & −3 \\ 1 & 2\end{aligned},\,−\begin{aligned}1 & −3 \\ 0 & 2\end{aligned},\,\begin{aligned}1 & 0 \\ 0 & 1\end{aligned}⟩ \\ & =⟨3,\,−2,\,1⟩.\end{aligned}
...
\begin{aligned}𝐫_{′𝑥}^{}×𝐫_{′𝑦}^{} & =\begin{aligned}𝐢 & 𝐣 & 𝐤 \\ 1 & 0 & \frac{𝜕𝑔}{𝜕𝑥} \\ 0 & 1 & \frac{𝜕𝑔}{𝜕𝑦}\end{aligned}=⟨−\frac{𝜕𝑔}{𝜕𝑥},\,−\frac{𝜕𝑔}{𝜕𝑦},\,1⟩.\end{aligned}
...
\iint\limits_S \mathbf{F} \cdot \textrm{d}\mathbf{S} = \iint\limits_D \Bigg( \boxed{\phantom{A}} \dfrac{\partial h}{\partial x} + Q - \boxed{\phantom{A}} \dfrac{\partial h}{\partial z} \Bigg) \: \textrm{d}A,
...
\begin{aligned}𝐫_{′𝑥}^{}×𝐫_{′𝑧}^{} & =\begin{aligned}𝐢 & 𝐣 & 𝐤 \\ 1 & \frac{𝜕ℎ}{𝜕𝑥} & 0 \\ 0 & \frac{𝜕ℎ}{𝜕𝑧} & 1\end{aligned}=⟨\frac{𝜕ℎ}{𝜕𝑥},\,−1,\,\frac{𝜕ℎ}{𝜕𝑧}⟩.\end{aligned}
