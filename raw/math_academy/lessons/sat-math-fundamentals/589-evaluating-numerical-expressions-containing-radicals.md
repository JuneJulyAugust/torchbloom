...
Source: https://www.mathacademy.com/topics/589?courseId=120
Topic ID: 589

## Prerequisites

- [Evaluating Expressions With Integer Exponents](../grade-8/1987-evaluating-expressions-with-integer-exponents.md)
...
where we have a square root sign. What would be the order of operations? It turns out that the root signs ($\sqrt{\phantom{x}}$ or $\sqrt[3]{\phantom{x}}$) can be thought of as parentheses. In other words, we find the value under the square root first:
...
\begin{aligned}(1−\sqrt[√−27]{3})÷2 & = \\ (1−\sqrt[√(−3)^{3}]{3})÷2 & = \\ (1−(−3))÷2 & = \\ 4÷2 & = \\ 2 & \end{aligned}


$$

### Example: Evaluating Expressions Containing Radicals and One or Two Additional Operations
...
\begin{aligned}7×\sqrt[√−8]{3} & = \\ 7×\sqrt[√(−2)⋅(−2)⋅(−2)]{3} & = \\ 7×\sqrt[√(−2)^{3}]{3} & = \\ 7×(−2) & = \\ −14. & \end{aligned}


$$

### Example: Evaluating Expressions Containing Radicals and Multiple Operations
...
### Example: Approximating Radical Expressions
