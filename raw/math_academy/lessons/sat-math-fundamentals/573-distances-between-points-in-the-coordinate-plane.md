...
![Instructional graphic](../../lesson-assets/sat-math-fundamentals/topic-573/9efea74b30c0e36a.png)

From the diagram, we see that the length of the segment is $4$ units, so the distance equals $4.$

![Instructional graphic](../../lesson-assets/sat-math-fundamentals/topic-573/5579f2d794f08d0b.png)
...
![Instructional graphic](../../lesson-assets/sat-math-fundamentals/topic-573/bfec2699ca818bfb.png)
...
![Instructional graphic](../../lesson-assets/sat-math-fundamentals/topic-573/5f35b5a5cd3040e6.png)
...
![Instructional graphic](../../lesson-assets/sat-math-fundamentals/topic-573/06b36c8794f7fe8c.png)

****

We can find the distance between the two points by finding the distance of each point from the $y$-axis and then subtracting.

![Instructional graphic](../../lesson-assets/sat-math-fundamentals/topic-573/c4dc895266501078.png)
...
![Instructional graphic](../../lesson-assets/sat-math-fundamentals/topic-573/a0c88b53a9377d98.png)

The distance between two points is the length of the line segment that connects them.

From the diagram, we see that the length of the segment is $3$ units, so the distance equals $3.$

![Instructional graphic](../../lesson-assets/sat-math-fundamentals/topic-573/39daaf2cad008bfc.png)
...
![Instructional graphic](../../lesson-assets/sat-math-fundamentals/topic-573/3280223472310275.png)
...
![Instructional graphic](../../lesson-assets/sat-math-fundamentals/topic-573/edb4549aed767860.png)

The distance between two points is the length of the line segment that connects them.

From the diagram, we see that the length of the segment is $4$ units, so the distance equals $4.$

![Instructional graphic](../../lesson-assets/sat-math-fundamentals/topic-573/335ac9be21d46b76.png)

**Method 2**

We can find the distance between the two points by finding the distance of each point from the $y$-axis and then adding.

![Instructional graphic](../../lesson-assets/sat-math-fundamentals/topic-573/898a366e012fdc4e.png)
...
![Instructional graphic](../../lesson-assets/sat-math-fundamentals/topic-573/30ca4b91b7412ece.png)

The distance between two points is the length of the line segment that connects them.

From the diagram, we see that the length of the segment is $7$ units, so the distance equals $7.$

![Instructional graphic](../../lesson-assets/sat-math-fundamentals/topic-573/9c06940bbde86448.png)

****

We can find the distance between the two points by finding the distance of each point from the $x$-axis and then adding.

![Instructional graphic](../../lesson-assets/sat-math-fundamentals/topic-573/5743e5dc801bfe72.png)
