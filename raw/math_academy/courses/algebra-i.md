...
Source: https://www.mathacademy.com/courses/algebra-i
Captured from the Math Academy course catalog on 2026-08-29.

## Overview

In this course, students will significantly broaden their understanding of equations and inequalities. This includes delving into one-variable equations and inequalities with unknown coefficients, two-variable linear equations and inequalities, and systems of equations and inequalities. Students will acquire the skills necessary to apply this knowledge in modeling a variety of real-world situations. Students will deepen their comprehension of units of measurement. They will learn to approach units from an algebraic perspective and master the art of using unit manipulations to solve problems. This course sees the introduction of functions into the student's mathematical journey. Here, they will explore fundamental concepts such as domain, range, roots, extrema, end behavior, and inverse functions. Armed with this knowledge, students will delve into the study of specific function types - including exponential, absolute value, and piecewise functions - establishing a solid foundation for analyzing more advanced functions in subsequent courses. Students will learn to perform arithmetic operations with rational and radical expressions and solve simple rational and radical equations. For the first time, students will encounter polynomials. They will become proficient in terminology associated with one-variable polynomials and master fundamental polynomial operations such as addition, subtraction, multiplication, and factoring. Students will master solving, graphing, and interpreting quadratic equations and functions. They will become adept at using various techniques for analyzing quadratics, including factoring, completing the square, and applying the quadratic formula. Real-world applications, including vertical motion and profit function analysis, are tackled within these units. In the final unit, students will explore the world of sequences. They will dive deeply into arithmetic and geometric sequences and learn to identify, model, and apply sequences in various situations.
...
## 2. Two-Variable Equations & Inequalities (33 topics)
...
- 2.7.9. Modeling Using Systems of Linear Equations
...
- 2.8.4. Systems of Linear Inequalities

- 2.8.5. Modeling With Two-Variable Linear Inequalities

- 2.8.6. Modeling With Systems of Linear Inequalities

- 2.8.7. Modeling and Solving Systems of Linear Inequalities Using Technology
...
## 4. Radical Expressions (12 topics)
...
- 4.11.11. Further Rationalizing Denominators of Algebraic Expressions

- 4.11.12. Solving Radical Equations

## 5. Rational Expressions & Equations (7 topics)
...
- 6.14.14. Constructing Linear Functions

- 6.14.15. The Arithmetic of Functions

- 6.14.16. Function Composition

- 6.14.17. Describing Function Composition

- 6.14.18. Introduction to Inverse Functions

## 7. Absolute Value (14 topics)
...
## 8. Exponential Functions (22 topics)
...
- 9.21.2. Factoring Polynomials Using GCFs
...
## 10. Quadratic Equations & Functions (37 topics)
...
- 10.22.16. Determining Unknown Parameters in Quadratic Equations With One Real Solution

- 10.22.17. Modeling With Quadratic Equations

- 10.22.18. Equating Polynomial Coefficients

- 10.22.19. Vieta's Formulas
...
- 10.23.11. Solving Systems of Nonlinear Equations

- 10.23.12. Finding Intersections of Lines and Quadratic Functions
...
## 12. Bivariate Statistics (6 topics)
