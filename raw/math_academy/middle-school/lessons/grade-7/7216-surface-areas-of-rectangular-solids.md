...
Source: https://www.mathacademy.com/topics/7216?courseId=37
Topic ID: 7216

## Prerequisites

- [Surface Areas of Cubes](./7214-surface-areas-of-cubes.md)

## Lesson

### Introduction

In this lesson, we'll learn how to compute the **surface area** of a rectangular solid.

Let's calculate the surface area of the rectangular prism shown below:

![Instructional graphic](../../../lesson-assets/grade-7/topic-7216/11e39217cf6387f1.png)
...
![Instructional graphic](../../../lesson-assets/grade-7/topic-7216/555d1620a6dd7f75.png)

As in the previous example, the surface area is made up of six faces:
...
![Instructional graphic](../../../lesson-assets/grade-7/topic-7216/29ec77e0b69bc24b.png)
...
### Determining Dimensions From the Surface Area

It turns out, we can determine the dimensions of a prism given its surface area and some other dimensions.

For example, let's determine the width of the rectangular solid below, given that its surface area is $100 \: \textrm{ft}^2.$

![Instructional graphic](../../../lesson-assets/grade-7/topic-7216/649665bb7788698e.png)
...
\begin{aligned}𝑆 & =2(𝑙𝑤+𝑙ℎ+𝑤ℎ) \\ 100 & =2(4𝑤+4⋅7+7𝑤) \\ 100 & =2(11𝑤+28) \\ 50 & =11𝑤+28 \\ 22 & =11𝑤 \\ 𝑤 & =2\end{aligned}



$$

Therefore, the width is $2 \: \textrm{ft}.$
...
![Instructional graphic](../../../lesson-assets/grade-7/topic-7216/2a5460505f852bdc.png)
...
Notice that the $lw$ term is missing from the expression for $S_L.$ This is because $lw$ represents the area of either the top or bottom face.
...
![Instructional graphic](../../../lesson-assets/grade-7/topic-7216/59027ddf215e54c1.png)
