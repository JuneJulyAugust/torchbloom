...
Source: https://www.mathacademy.com/topics/645?courseId=31
Topic ID: 645

## Prerequisites

- [Identifying Terms in Linear Expressions](./643-identifying-terms-in-linear-expressions.md)
...
### Example: Listing the Coefficients of an Expression
...
### Example: Listing Fractional Coefficients When the Variable is in a Numerator
...
So, the coefficients of $a$ and $b$ in the given expression are $\boxed{\color{blue}\dfrac{3}{5}}$ and $\boxed{\color{blue}-10},$ respectively.
...
### Example: Identifying the Constant Term of an Expression
...
and we can replace $0$ with $0z$ to get:
...
### Example: Identifying the Missing Constant or the Coefficient of a Missing Variable
