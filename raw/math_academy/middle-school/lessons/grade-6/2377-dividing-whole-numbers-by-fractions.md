...
Source: https://www.mathacademy.com/topics/2377?courseId=31
Topic ID: 2377

## Prerequisites

- [Dividing Whole Numbers by Unit Fractions](../../../elementary-school/lessons/grade-5/533-dividing-whole-numbers-by-unit-fractions.md)
...
### Example: Dividing Whole Numbers by Fractions
...
### Example: Applying a Strategy (Result Is a Whole Number)
...
\begin{aligned}\frac{8}{1}×\frac{5}{2} & =\frac{8}{2}×\frac{5}{1} \\ & =4×5 \\ & =20\end{aligned}



$$

### Example: Applying a Strategy (Result Is a Fraction or Mixed Number)
...
\begin{aligned}\frac{2}{1}×\frac{7}{6} & =\frac{2}{6}×\frac{7}{1} \\ & =\frac{1}{3}×\frac{7}{1} \\ & =\frac{1×7}{3×1} \\ & =\frac{7}{3}\end{aligned}
