...
Source: https://www.mathacademy.com/topics/55?courseId=154
Topic ID: 55
...
\begin{aligned}𝑇_{2} & ={1,2,…,2(2)+1} \\ & ={1,2,…,5} \\ & ={1,2,3,4,5}.\end{aligned}
...
\begin{aligned}\underset{\underset{𝑖=1}{⋃}}{\overset{}{∞}}𝑋_{𝑖}=ℤ\end{aligned}
...
\begin{aligned}\underset{𝑖∈ℕ}{⋂}𝑆_{𝑖}={0}.\end{aligned}
...
\begin{aligned}\underset{\underset{𝑖=1}{⋂}}{\overset{}{∞}}𝑆_{𝑖}={0}\end{aligned}
...
The union of a family of indexed sets is the set containing all elements belonging to ** set in the indexed family:
...
\begin{aligned}\underset{𝑖∈𝐼}{⋃}𝑆_{𝑖} & =𝑆_{−1}∪𝑆_{0}∪𝑆_{1} \\ & =(−2,0)\,∪\,(−1,1)\,∪\,(0,2) \\ & =(−2,2).\end{aligned}
...
The intersection of a family of indexed sets $\{A_i\}_{i\in I}$ contains all elements that belong to ** sets in our family:
...
\begin{aligned}\underset{𝑖∈𝐼}{⋂}𝑋_{𝑖}=∅.\end{aligned}
