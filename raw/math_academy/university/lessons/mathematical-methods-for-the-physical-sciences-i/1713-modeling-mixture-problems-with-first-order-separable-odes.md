...
Source: https://www.mathacademy.com/topics/1713?courseId=154
Topic ID: 1713

## Prerequisites

- [Modeling Mixture Problems](../../../high-school/traditional/lessons/algebra-i/1021-modeling-mixture-problems.md)
...
![Instructional graphic](../../../lesson-assets/mathematical-methods-for-the-physical-sciences-i/topic-1713/6a419fe3cd8ccb2a.png)

How can we model the amount $Q$ (in pounds) of substance in the container at time $t?$

To model $Q(t),$ we can analyze how it changes over time. The rate of change of the amount of substance in the container is given by
...
\dfrac{\mathrm{d}Q}{\mathrm{d}t} = be - f\left(\dfrac{Q}{V_0 + et - ft}\right) \quad\Longrightarrow\quad \boxed{\dfrac{\mathrm{d}Q}{\mathrm{d}t} + f\left(\dfrac{Q}{V_0 + et - ft}\right) = be}
...
\begin{aligned}\frac{d𝑄}{d𝑡}+\frac{4}{225}𝑄=0.\end{aligned}


$$

### Example: Constructing a Dilution Model
...
****: Calculating the rate at which sugar exits the vat.
...
Since $Q$ is the mass of sugar in the vat, the ** of the solution at time $t$ is
...
****: Calculate the overall rate of change.
...
\begin{aligned}\frac{d𝑄}{d𝑡}+\frac{5}{60−2𝑡}𝑄=5.4.\end{aligned}
...
\begin{aligned}∫\frac{1}{𝑄}⋅\frac{d𝑄}{d𝑡}\,d𝑡 & =∫(−\frac{4}{225})\,d𝑡 \\ ∫\frac{1}{𝑄}\,d𝑄 & =−\frac{4}{225}∫d𝑡 \\ ln⁡|𝑄| & =−\frac{4𝑡}{225}+𝐶 \\ 𝑄 & =𝑒^{−4𝑡/225+𝐶} \\ 𝑄(𝑡) & =𝐴𝑒^{−4𝑡/225}\end{aligned}
...
\begin{aligned}𝑄(0) & =6 \\ 𝐴𝑒^{−4(0)/225} & =6 \\ 𝐴 & =6\end{aligned}
...
### Example: Constructing and Solving a Dilution Model
...
****: Calculating the rate at which reactant exits the reactor.
...
Since $Q$ is the amount of reactant in the reactor, the ** of the solution at time $t$ is
...
\begin{aligned}\frac{1}{𝑄}⋅\frac{d𝑄}{d𝑡} & =−\frac{7}{150} \\ ∫\frac{1}{𝑄}⋅\frac{d𝑄}{d𝑡}d𝑡 & =∫(−\frac{7}{150})\,d𝑡 \\ ∫\frac{1}{𝑄}⋅\,d𝑄 & =−\frac{7}{150}∫1\,d𝑡 \\ ln⁡|𝑄| & =−\frac{7𝑡}{150}+𝐶 \\ |𝑄| & =𝑒^{−\frac{7𝑡}{150}+𝐶} \\ 𝑄(𝑡) & =𝐴𝑒^{−7𝑡/150},\end{aligned}
...
\begin{aligned}𝑄(0) & =18 \\ 𝐴𝑒^{−7⋅0/150} & =18 \\ 𝐴 & =18\end{aligned}
...
- The volume *remains constant* when the input rate equals the output rate, $e=f.$ In this case,

- The volume *decreases* when the output rate is greater than the input rate, $f > e > 0,$ and the container begins to empty. Let $t_e$ be the time when the container empties: $V(t_e) = 0.$ Solving for $t_e,$ we get Solving this equation, we find that the container empties at time $\boxed{t_e = \dfrac{V_0}{f - e}}.$

- The volume *increases* when the input rate is greater than the output rate, $e > f > 0,$ and the container begins filling until it reaches its capacity $V_\text{cap}.$ Let $t_o$ be the time when the container reaches capacity: $V(t_o) = V_\text{cap}.$ Solving for $t_o,$ we get Solving this equation, we find that the container overflows at time $\boxed{t_o = \dfrac{V_\text{cap} - V_0}{e - f}}.$

Now, let's apply one of these formulas in a concrete example.

### Example: Determining an Amount at an Overflow Point
...
****: Calculating the rate at which contaminant exits the tank.
...
\begin{aligned}\frac{1}{𝑄}⋅\frac{d𝑄}{d𝑡} & =−\frac{3}{2(200+𝑡)} \\ ∫\frac{1}{𝑄}⋅\frac{d𝑄}{d𝑡}d𝑡 & =∫(−\frac{3}{2(200+𝑡)})\,d𝑡 \\ ∫\frac{1}{𝑄}⋅\,d𝑄 & =−\frac{3}{2}∫\frac{1}{200+𝑡}\,d𝑡 \\ ln⁡|𝑄| & =−\frac{3}{2}(ln⁡|200+𝑡|)+𝐶 \\ ln⁡|𝑄| & =ln⁡|(200+𝑡)^{−3/2}|+𝐶 \\ |𝑄| & =𝑒^{ln⁡|(200+𝑡)^{−3/2}|+𝐶} \\ 𝑄(𝑡) & =\frac{𝐴}{(200+𝑡)^{3/2}},\end{aligned}
...
\begin{aligned}𝑄(0) & =320 \\ \frac{𝐴}{(200+0)^{3/2}} & =320 \\ 𝐴 & =320(200)^{3/2}\end{aligned}
...
\begin{aligned}𝑄(𝑡) & =\frac{320(200)^{3/2}}{(200+𝑡)^{3/2}} \\ & =320(\frac{200}{200+𝑡})^{3/2}\end{aligned}
...
\begin{aligned}𝑉(𝑡_{𝑜}) & =12\,000 \\ 40(200+𝑡_{𝑜}) & =12\,000 \\ 200+𝑡_{𝑜} & =300 \\ 𝑡_{𝑜} & =100\,s\end{aligned}
...
\begin{aligned}𝑄(100) & =320(\frac{200}{200+100})^{3/2} \\ & =320(\frac{2}{3})^{3/2} \\ & ≈174.19\,g.\end{aligned}
