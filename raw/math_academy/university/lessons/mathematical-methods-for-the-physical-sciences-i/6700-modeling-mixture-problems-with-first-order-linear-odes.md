...
Source: https://www.mathacademy.com/topics/6700?courseId=154
Topic ID: 6700
...
- [Modeling Mixture Problems With First-Order Separable ODEs](./1713-modeling-mixture-problems-with-first-order-separable-odes.md)
...
### Example: Constructing and Solving a Dilution Model: Inflow Equals Outflow
...
\begin{aligned}𝑄(0) & =7 \\ 𝐴𝑒^{−0/20}+8 & =7 \\ 𝐴 & =−1\end{aligned}
...
****: Calculating the rate at which coagulant exits the tank.
...
Since $Q$ is the amount of coagulant in the tank, the ** of the mixed solution at time $t$ is
...
\begin{aligned}\frac{d𝑄}{d𝑡}+\frac{2}{70+𝑡}𝑄=1.5.\end{aligned}
...
\begin{aligned}𝐼(𝑡) & =𝑒^{∫2/(70+𝑡)\,d𝑡} \\ & =𝑒^{2ln⁡|70+𝑡|} \\ & =𝑒^{ln⁡(70+𝑡)^{2}} \\ & =(70+𝑡)^{2}\end{aligned}


$$

Multiplying both sides of the differential equation by $I(t) = (70+t)^2$ yields

$$


\begin{aligned}(70+𝑡)^{2}⋅(\frac{d𝑄}{d𝑡}+\frac{2}{70+𝑡}𝑄) & =(70+𝑡)^{2}⋅1.5 \\ (70+𝑡)^{2}\frac{d𝑄}{d𝑡}+2(70+𝑡)𝑄 & =1.5(70+𝑡)^{2} \\ \frac{d}{d𝑡}(𝑄(70+𝑡)^{2}) & =1.5(70+𝑡)^{2}.\end{aligned}
...
\begin{aligned}∫\frac{d}{d𝑡}(𝑄(70+𝑡)^{2})\,d𝑡 & =∫1.5(70+𝑡)^{2}\,d𝑡 \\ 𝑄(70+𝑡)^{2} & =1.5⋅\frac{1}{3}(70+𝑡)^{3}+𝐶 \\ 𝑄(𝑡) & =0.5(70+𝑡)+\frac{𝐶}{(70+𝑡)^{2}}\end{aligned}
...
\begin{aligned}𝑄(0) & =12 \\ 0.5(70+0)+\frac{𝐶}{(70+0)^{2}} & =12 \\ 35+\frac{𝐶}{70^{2}} & =12 \\ \frac{𝐶}{70^{2}} & =−23 \\ 𝐶 & =−23(70)^{2}\end{aligned}
...
\begin{aligned}𝑄(𝑡) & =0.5(70+𝑡)−\frac{23(70)^{2}}{(70+𝑡)^{2}} \\ & =0.5(70+𝑡)−23(\frac{70}{70+𝑡})^{2}.\end{aligned}
...
\begin{aligned}𝑄(8) & =0.5(70+8)−23(\frac{70}{70+8})^{2} \\ & =39−23(\frac{70}{78})^{2} \\ & ≈20.48\,kg,\end{aligned}
...
****: Calculating the rate at which sugar exits the tank.
...
\begin{aligned}𝐼(𝑡) & =𝑒^{∫2/(12+𝑡)\,d𝑡} \\ & =𝑒^{2ln⁡|12+𝑡|} \\ & =𝑒^{ln⁡(12+𝑡)^{2}} \\ & =(12+𝑡)^{2}.\end{aligned}


$$

Multiplying both sides of the differential equation by $I(t) = (12+t)^2$ yields

$$


\begin{aligned}(12+𝑡)^{2}⋅(\frac{d𝑄}{d𝑡}+\frac{2}{12+𝑡}\,𝑄) & =(12+𝑡)^{2}⋅36 \\ (12+𝑡)^{2}\frac{d𝑄}{d𝑡}+2(12+𝑡)𝑄 & =36(12+𝑡)^{2} \\ \frac{d}{d𝑡}(𝑄(12+𝑡)^{2}) & =36(12+𝑡)^{2}.\end{aligned}
...
\begin{aligned}∫\frac{d}{d𝑡}(𝑄(12+𝑡)^{2})\,d𝑡 & =∫36(12+𝑡)^{2}\,d𝑡 \\ 𝑄(12+𝑡)^{2} & =36⋅\frac{1}{3}(12+𝑡)^{3}+𝐶 \\ 𝑄(𝑡) & =12(12+𝑡)+\frac{𝐶}{(12+𝑡)^{2}}.\end{aligned}
...
\begin{aligned}𝑄(0) & =32 \\ 12(12+0)+\frac{𝐶}{(12+0)^{2}} & =32 \\ 12⋅12+\frac{𝐶}{(12)^{2}} & =32 \\ 144+\frac{𝐶}{12^{2}} & =32 \\ \frac{𝐶}{12^{2}} & =−112 \\ 𝐶 & =−112(12)^{2}.\end{aligned}
...
\begin{aligned}𝑄(𝑡) & =12(12+𝑡)−\frac{112(12)^{2}}{(12+𝑡)^{2}} \\ & =12(12+𝑡)−112(\frac{12}{12+𝑡})^{2}.\end{aligned}
...
\begin{aligned}𝑉(𝑡_{𝑜}) & =240 \\ 96+24𝑡_{𝑜}−16𝑡_{𝑜} & =240 \\ 96+8𝑡_{𝑜} & =240 \\ 8𝑡_{𝑜} & =144 \\ 𝑡_{𝑜} & =18\,min.\end{aligned}
...
\begin{aligned}𝑄(18) & =12(12+18)−112(\frac{12}{12+18})^{2} \\ & =360−112(\frac{12}{30})^{2} \\ & ≈342.1\,lb.\end{aligned}
