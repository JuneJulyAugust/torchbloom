...
Source: https://www.mathacademy.com/topics/1161?courseId=106
Topic ID: 1161
...
\dfrac{\text{d}u}{\text{d}x}= \dfrac 1 x\quad \Longrightarrow \quad \dfrac 1 x \,\text{d}x={\text{d}u}.
...
\begin{aligned} \int \dfrac{\ln x}{x}\, \text{d}x &=\int \ln x\cdot \dfrac {1} {x} \,\textrm d x \\[5pt] & = \int u \, \text{d} u \\[5pt] &= \dfrac{1}{2}u^2 +C \\[5pt] &= \dfrac{1}{2}\ln^2 x +C\end{aligned}
...
Calculate $\displaystyle{\int \dfrac{3}{x \sqrt{\ln x}} \, \text{d}x}.$
...
\dfrac{\text{d}u}{\text{d}x}= \dfrac 1 x\quad\Longrightarrow\quad \text{d}u=\dfrac 1 x\,{\text{d}x}.
...
\begin{aligned}\begin{matrix}∫\frac{3}{𝑥\sqrt{ln⁡𝑥}}\,d𝑥 & =3∫\frac{1}{\sqrt{ln⁡𝑥}}⋅\frac{1}{𝑥}\,d𝑥 \\ & =3∫\frac{1}{\sqrt{𝑢}}\,d𝑢 \\ & =3∫𝑢^{−1/2}\,d𝑢 \\ & =3⋅2𝑢^{1/2}+𝐶 \\ & =6\sqrt{𝑢}+𝐶 \\ & =6\sqrt{ln⁡𝑥}+𝐶\end{matrix}\end{aligned}
...
\displaystyle{\int_{e}^{e^4} \dfrac{3}{x \sqrt{\ln x}} \, \text{d}x }
...
\dfrac{\text{d}u}{\text{d}x} = \dfrac{1}{x} \qquad\Longrightarrow\qquad \text{d}u = \dfrac{\text{d}x}{x}.
...
Evaluate $\displaystyle{\int_{e}^{e^2} \dfrac{\ln^2 x}{x}\,\text{d}x}.$
...
\begin{aligned} \int_{e}^{e^2} \dfrac{\ln^2 x}{x}\,\text{d}x &= \int_{e}^{e^2} (\ln x)^2\cdot \dfrac{\text{d}x}{x}\\[5pt] &=\int_{1}^{2} u^2\,\text{d}u\\[5pt] &=\left.\dfrac13u^{3}\right|_{1}^{2}\\[5pt] &=\dfrac{1}{3}\left(2^3-1^3 \right)\\[5pt] &=\dfrac{1}{3}\left(8-1 \right)\\[5pt] &=\dfrac{7}{3} \end{aligned}
