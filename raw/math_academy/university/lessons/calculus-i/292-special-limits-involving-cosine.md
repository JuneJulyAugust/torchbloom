...
Source: https://www.mathacademy.com/topics/292?courseId=105
Topic ID: 292

## Prerequisites

- [Simplifying Expressions Using the Pythagorean Identity](../../../high-school/integrated-math-honors/lessons/integrated-math-iii-honors/207-simplifying-expressions-using-the-pythagorean-identity.md)
- [Calculating Limits of Rational Functions by Factoring](./1813-calculating-limits-of-rational-functions-by-factoring.md)
- [Evaluating Special Limits Involving Sine Using a Substitution](./3678-evaluating-special-limits-involving-sine-using-a-substitution.md)
...
![Instructional graphic](../../../lesson-assets/calculus-i/topic-292/76c400ed334ec0a4.png)
