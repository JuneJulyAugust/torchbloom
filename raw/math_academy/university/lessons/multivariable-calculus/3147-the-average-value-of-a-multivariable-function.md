...
Source: https://www.mathacademy.com/topics/3147?courseId=54
Topic ID: 3147

## Prerequisites

- [The Average Value of a Function](../../../ap-courses/lessons/ap-calculus-ab/1203-the-average-value-of-a-function.md)
...
![Instructional graphic](../../../lesson-assets/multivariable-calculus/topic-3147/69685e3570e94b89.png)
...
\iint\limits_D f(x,y) \: \text{d}A = f(a,b) \cdot \text{Area}(D).
...
![Instructional graphic](../../../lesson-assets/multivariable-calculus/topic-3147/2f9dfd1dd9268bbf.png)
...
![Instructional graphic](../../../lesson-assets/multivariable-calculus/topic-3147/fa5acf06f6b50129.png)
...
![Instructional graphic](../../../lesson-assets/multivariable-calculus/topic-3147/192cb658716041dc.png)
...
f_\text{ave} = \dfrac{1}{\text{Length}(D)}\int_a^b f(x) \: \text{d}x.
...
*Suppose $D$ is a closed and bounded region in $\mathbb{R}^2$ which has non-zero finite area $\text{Area}(D).$ If $f (x, y)$ is a continuous function on $D,$ then **** is given by*

$$


f_{\text{ave}} =\dfrac{1}{\text{Area}(D)} \, \iint\limits_D f(x,y) \: \text{d}A.
...
![Instructional graphic](../../../lesson-assets/multivariable-calculus/topic-3147/169a927f18569fef.png)
...
\text{Area}(D) = \dfrac{1}{4} \cdot \pi \cdot 1^2 = \dfrac\pi 4.
...
f_{\text{ave}} = \dfrac{4}{\pi} \cdot 1 = \dfrac{4}{\pi}.
