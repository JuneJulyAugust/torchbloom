...
Source: https://www.mathacademy.com/topics/4255?courseId=76
Topic ID: 4255
...
![Instructional graphic](../../../lesson-assets/methods-of-proof/topic-4255/febaab8ff8a7718a.png)

To get the truth set of $P(x,y) \lor Q(x,y),$ we take all the points that belong to $T_P$ or $T_Q,$ as shown below.

![Instructional graphic](../../../lesson-assets/methods-of-proof/topic-4255/0a05cf93d288eceb.png)
