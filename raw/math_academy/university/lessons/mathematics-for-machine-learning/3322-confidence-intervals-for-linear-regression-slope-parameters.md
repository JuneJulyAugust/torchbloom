...
Source: https://www.mathacademy.com/topics/3322?courseId=145
Topic ID: 3322
...
![Instructional graphic](../../../lesson-assets/mathematics-for-machine-learning/topic-3322/ad8fe47a4817aa87.png)
...
![Instructional graphic](../../../lesson-assets/mathematics-for-machine-learning/topic-3322/4292231b3996ef35.png)
...
\widehat{\,\beta}_1 \: \pm \: \overbrace{t_{n-2,\alpha/2} \cdot \text{SE}[\widehat{\,\beta}_1\,] }^{\text{margin of error}}.
...
- $\text{SE}[\widehat{\,\beta}_1\,]$ is the standard error of $\widehat{\,\beta}_1,$ given by where we have: $\text{MSE}$ is the so-called **mean squared error** of the model, given by where $\widehat{\,y}_i$ is the estimate of $y_i$ given by our regression model. $S_{xx}$ is the usual sum of squares formula:
...
- $\text{SE}[\widehat{\,\beta}_1\,]$ is the standard error of $\widehat{\,\beta}_1,$ given by where we have: $\text{MSE}$ is the mean squared error of the model: where $\widehat{\,y}_i$ is the estimate of $y_i$ given by our regression model. $S_{xx}$ is the usual sum of squares formula:
...
The table above shows the number of hours each of four students spent studying for a biology exam and the grades they finally obtained on that exam. The corresponding fitted linear regression line using this sample is $\widehat{\,y} = 21.3 + 10x.$ Assuming that all conditions for the simple regression model are satisfied, $\overline{x}=5,$ and $\text{MSE}=1.375,$ find a $90\%$ confidence interval for the slope of the regression line.
...
\text{SE}[\widehat{\,\beta}_1\,] = \sqrt{ \dfrac{\text{MSE}}{S_{xx}}}.
...
![Instructional graphic](../../../lesson-assets/mathematics-for-machine-learning/topic-3322/9ffed31f6bdc410a.png)
...
\textrm E[\widehat{\beta}_1] = \beta_1, \qquad \text{Var}[\widehat{\beta_1}] = \dfrac{\sigma^2}{S_{xx}}.
...
\dfrac{\widehat{\beta}_1 -\beta_1}{\text{SE}[\widehat{\beta_1}] }
