...
Source: https://www.mathacademy.com/topics/1990?courseId=145
Topic ID: 1990

## Prerequisites

- [Defining Definite Integrals Using Left and Right Riemann Sums](../../../ap-courses/lessons/ap-calculus-ab/1086-defining-definite-integrals-using-left-and-right-riemann-sums.md)
...
![Instructional graphic](../../../lesson-assets/mathematics-for-machine-learning/topic-1990/979873c14c171d50.png)

Then, we refine $P$ by adding more points to $P_1$ and $P_2,$ resulting in more rectangles in $P{:}$

![Instructional graphic](../../../lesson-assets/mathematics-for-machine-learning/topic-1990/bdc8bd90966f0d61.png)

Refining the partition once again, we get the following:

![Instructional graphic](../../../lesson-assets/mathematics-for-machine-learning/topic-1990/a9560c17bba3d0e5.png)
