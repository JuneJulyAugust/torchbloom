...
Source: https://www.mathacademy.com/topics/2424?courseId=75
Topic ID: 2424
...
****: First, we subtract $3 \times {\color{blue}10} = 30$ from $51.$

****: Next, we bring $\color{red}21$ to the right.

****: Pick a multiple of $3$ that is easy to compute but is no larger than ${\color{red}21}.$ Let's pick $3 \times {\color{blue}7} = 21.$
...
****: First, we subtract $7 \times {\color{blue}10} = 70$ from $91.$

****: Next, we bring $\color{red}21$ to the right.

****: Pick a multiple of $7$ that is easy to compute but is no larger than ${\color{red}21}.$ Let's pick $7 \times {\color{blue}3} = 21.$
