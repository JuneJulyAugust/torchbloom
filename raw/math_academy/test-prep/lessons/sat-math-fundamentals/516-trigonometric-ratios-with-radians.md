...
Source: https://www.mathacademy.com/topics/516?courseId=120
Topic ID: 516
...
### Example: Finding a Trigonometric Ratio
...
### Example: Finding an Inverse Trigonometric Ratio
...
\begin{aligned}sin⁡(\frac{𝜋}{10}) & =sin⁡(18^{∘}) \\ & =0.309\,016… \\ & ≈0.309\end{aligned}
...
### Example: Finding a Trigonometric Ratio of an Acute Special Angle
...
Finally, since we know that $\sin 30^\circ = \dfrac{1}{2},$ we obtain
