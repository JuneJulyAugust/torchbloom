...
Source: https://www.mathacademy.com/topics/3718?courseId=120
Topic ID: 3718

## Prerequisites

- [Multiplying Two-Digit Decimals](../../../elementary-school/lessons/grade-5/111-multiplying-two-digit-decimals.md)
- [Multiplying Positive Numbers With Negative Numbers](../../../middle-school/lessons/grade-7/298-multiplying-positive-numbers-with-negative-numbers.md)
- [Multiplying Fractions](../../../elementary-school/lessons/grade-5/2378-multiplying-fractions.md)
...
Now, to compute the number in the box, we multiply $2$ by $8$ without any signs: $2 \cdot 8 = 16$. Therefore,
...
Now, to compute the number that goes in the box, we multiply $9$ and $5$ without any signs: $9 \cdot 5 = 45.$ So, we get
...
\begin{aligned}(−\frac{1}{2})⋅(−\frac{10}{3}) & =\frac{1}{2}⋅\frac{10}{3}\end{aligned}
...
\begin{aligned}\frac{1}{2}⋅\frac{10}{3} & =\frac{1⋅10}{2⋅3} \\ & =\frac{5⋅2}{2⋅3} \\ & =\frac{5⋅2}{2⋅3} \\ & =\frac{5}{3}\end{aligned}
...
- Subtracting a number is the same as adding its opposite: For example, $2-3 = 2 + (-3).$

- The **commutative law**: For any numbers $a$ and $b,$ we have: For example, $2\cdot 3 = 3\cdot 2.$

- The **distributive law**: For any numbers $a, b$ and $c,$ we have: For example, $2\cdot (3+4) = 2\cdot 3 + 2\cdot 4.$
