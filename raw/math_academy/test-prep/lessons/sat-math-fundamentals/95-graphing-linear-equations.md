...
Source: https://www.mathacademy.com/topics/95?courseId=120
Topic ID: 95

## Prerequisites

- [Two-Variable Linear Equations and Their Solutions](../../../middle-school/lessons/grade-7/94-two-variable-linear-equations-and-their-solutions.md)
...
![Instructional graphic](../../../lesson-assets/sat-math-fundamentals/topic-95/2d988f37185d91c5.png)

Finally, connecting the points gives us a **straight line**.

![Instructional graphic](../../../lesson-assets/sat-math-fundamentals/topic-95/f500326537780758.png)
...
![Instructional graphic](../../../lesson-assets/sat-math-fundamentals/topic-95/53873c82dd1c970f.png)

Finally, connecting the points gives us a straight line. This is the graph of $y=3x-2.$

![Instructional graphic](../../../lesson-assets/sat-math-fundamentals/topic-95/a3844759a94e3b44.png)
...
![Instructional graphic](../../../lesson-assets/sat-math-fundamentals/topic-95/d18e2b3d09d196b1.png)

However, given only two points $(0, -2)$ and $(3, 7)$, we can still draw the same line through them:

![Instructional graphic](../../../lesson-assets/sat-math-fundamentals/topic-95/27fd534a66f4898e.png)
...
![Instructional graphic](../../../lesson-assets/sat-math-fundamentals/topic-95/e361ddcabe8bb590.png)
...
![Instructional graphic](../../../lesson-assets/sat-math-fundamentals/topic-95/87f5e82ed9b73a61.png)

#### Explanation

Let's pick two distinct points on the line. For example, we can choose $A$ and $B$ with coordinates $(0,-1)$ and $(2,3)$, respectively.

![Instructional graphic](../../../lesson-assets/sat-math-fundamentals/topic-95/463c8785cb59a4d9.png)
...
![Instructional graphic](../../../lesson-assets/sat-math-fundamentals/topic-95/ac74eb51fc7011f1.png)
