...
Source: https://www.mathacademy.com/topics/2509?courseId=120
Topic ID: 2509
...
### Example: Finding a Particular Frequency in a Frequency Table
...
### Example: Finding a Missing Frequency in a Frequency Table
...
We need to count the number of hours in which the number of smartphones sold was between and

From the data, there were hours when the number of smartphones sold was between and:

Therefore, the missing value is

### Example: Finding the Total Count From a Frequency Table
...
### Example: Finding a Partial Count From a Frequency Table
