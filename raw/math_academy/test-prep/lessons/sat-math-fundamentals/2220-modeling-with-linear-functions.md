...
Source: https://www.mathacademy.com/topics/2220?courseId=120
Topic ID: 2220

## Prerequisites

- [Introduction to Functions](../../../high-school/traditional/lessons/algebra-i/470-introduction-to-functions.md)
- [Further Modeling With Linear Equations in Two Variables](../../../high-school/traditional/lessons/algebra-i/3765-further-modeling-with-linear-equations-in-two-variables.md)
...
\begin{aligned}𝐻(36) & =120+3(36) \\ & =120+108 \\ & =228.\end{aligned}
...
### Example: Evaluating a Linear Function Model

#### Question

The temperature $T$ of a liquid, in degrees Fahrenheit, $t$ minutes after it starts cooling is given by
...
\begin{aligned}𝑇(24) & =80−1.75(24) \\ & =80−42 \\ & =38.\end{aligned}
...
$\qquad$ *When $\color{blue}20$ visitors come to the restaurant, the restaurant earns a $\color{red}250$ profit.*

### Example: Interpreting Function Notation in an Applied Context

#### Question

The number of people living in Pasadena, California, can be modeled by the function
...
- The constant $-150$ is the amount of profit the restaurant earns when $0$ visitors come to the restaurant. In other words, the restaurant loses $150$ if no visitors come.
...
### Example: Interpreting Parts of a Function in an Applied Context

#### Question

The number of hours per year that people in a particular country spent on social media can be modeled by the function
...
### Example: Writing a Statement Using Function Notation
...
After $5$ months, Alan saved $100$ more than he did after $4$ months, so $S(5)$ is $100$ more than $S(4).$ Therefore, we have
