...
Source: https://www.mathacademy.com/topics/4029?courseId=120
Topic ID: 4029

## Prerequisites

- [Absolute Value Equations](../../../high-school/traditional/lessons/algebra-i/384-absolute-value-equations.md)
...
\begin{aligned}2|𝑥−1|+4 & =8 \\ 2|𝑥−1|+4−4 & =8−4 \\ 2|𝑥−1| & =4\end{aligned}
...
\begin{aligned}2|𝑥−1| & =4 \\ \frac{2|𝑥−1|}{2} & =\frac{4}{2} \\ \frac{2|𝑥−1|}{2} & =2 \\ |𝑥−1| & =2\end{aligned}
...
### Example: Isolating an Absolute Value Expression
...
\begin{aligned}−3|1−𝑥|−2 & =−8 \\ −3|1−𝑥|−2+2 & =−8+2 \\ −3|1−𝑥| & =−6\end{aligned}
...
\begin{aligned}−3|1−𝑥| & =−6 \\ \frac{−3|1−𝑥|}{−3} & =\frac{−6}{−3} \\ \frac{−3|1−𝑥|}{−3} & =2 \\ |1−𝑥| & =2\end{aligned}
...
\begin{aligned}|𝑥| & =−4 \\ |4| & =−4 \\ 4 & =−4\,×\end{aligned}
...
Which of the following equations has ** solution?
...
- Equation I **. The absolute value is already isolated on the left-hand side, and the right-hand side is **.

- Equation II **. To see this, we first isolate the absolute value on the left-hand side as follows: Since the right-hand side is **, this equation has ** solution.
...
### Example: Rearranging and Solving an Absolute Value Equation
...
\begin{aligned}2|2𝑎−4|−7 & =13 \\ 2|2𝑎−4| & =20 \\ |2𝑎−4| & =10\end{aligned}
