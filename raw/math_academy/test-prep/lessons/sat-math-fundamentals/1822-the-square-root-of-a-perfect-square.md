...
Source: https://www.mathacademy.com/topics/1822?courseId=120
Topic ID: 1822
...
![Instructional graphic](../../../lesson-assets/sat-math-fundamentals/topic-1822/d77b5a257deae0b0.png)

We can pile up these items to form a square, where the length of each side equals $\sqrt{9}={\color{blue}3}\mathbin{:}$

![Instructional graphic](../../../lesson-assets/sat-math-fundamentals/topic-1822/6725415cb69821d3.png)
...
Finally, if $a$ represents a number that's either positive or zero (i.e., $a\geq 0$), then
...
### Example: The Square Root of a Positive Number Squared
...
### Example: The Square Root of a Perfect Square
...
### Example: The Square Root of a Fraction
...
### Example: Determining Whether a Square Root Is a Real Number
