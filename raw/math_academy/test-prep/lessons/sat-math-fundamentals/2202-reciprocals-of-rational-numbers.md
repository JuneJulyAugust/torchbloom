...
Source: https://www.mathacademy.com/topics/2202?courseId=120
Topic ID: 2202
...
### Example: Finding the Reciprocal of an Integer

#### Question

What is the reciprocal of $-21?$
...
### Example: Finding the Reciprocal of a Fraction

#### Question

Find the reciprocal of $\dfrac{1}{10}.$

#### Explanation

We flip the numerator and the denominator. So, the reciprocal of $\dfrac{1}{10}$ is $\dfrac{10}{1} = 10.$

### Example: Finding the Reciprocal of a Mixed Number
...
Then, we flip the numerator and the denominator, keeping the negative sign. Therefore, the reciprocal of $-2\,\dfrac{1}{3}$ is $-\dfrac{3}{7}.$
