...
Source: https://www.mathacademy.com/topics/1224?courseId=120
Topic ID: 1224
...
\begin{aligned}(3^{5})^{4} & = \\ \underset{4 copies}{\underset{}{3^{5}×3^{5}×3^{5}×3^{5}}} & = \\ 3^{5+5+5+5} & = \\ 3^{5⋅4} & = \\ 3^{20} & \end{aligned}


$$

### Example: Applying the Power Rule With Positive Integer Exponents
...
### Example: Applying the Power Rule With Negative Integer Exponents
...
### Example: Applying the Power Rule With Negative Integer Exponents and Formatting the Result
