...
Source: https://www.mathacademy.com/topics/1778?courseId=120
Topic ID: 1778

## Prerequisites

- [The Pythagorean Theorem](../../../high-school/traditional/lessons/geometry/433-the-pythagorean-theorem.md)
...
![Instructional graphic](../../../lesson-assets/sat-math-fundamentals/topic-1778/6a541d13d47f733d.png)
...
![Instructional graphic](../../../lesson-assets/sat-math-fundamentals/topic-1778/975974ffbcf6e19e.png)
...
![Instructional graphic](../../../lesson-assets/sat-math-fundamentals/topic-1778/e42dd44c70bd176b.png)
...
Calculate the slant height of a right cone whose base radius and height are $8 \: \textrm{in}$ and $15 \: \textrm{in},$ respectively.

#### Explanation

Let $r,$ $h,$ and $l$ denote the cone's base radius, height, and slant height, respectively.

![Instructional graphic](../../../lesson-assets/sat-math-fundamentals/topic-1778/d6224627355a6da2.png)

In our case, $r=8\,\textrm{in}, h = 15\,\textrm{in},$ and $l$ is to be found.
...
![Instructional graphic](../../../lesson-assets/sat-math-fundamentals/topic-1778/973fd84faf91e37e.png)

#### Explanation

Let $r,$ $h,$ and $l$ denote the cone's base radius, height, and slant height, respectively.

![Instructional graphic](../../../lesson-assets/sat-math-fundamentals/topic-1778/8894156dfeb7d2c8.png)

In our case, $l = 50\,\textrm{cm},$ and $r$ and $h$ are to be found. Additionally, we're given that $C=28 \pi\, \text{cm},$ where $C$ is the circumference of the base.
...
Substitutuing $C = 28 \pi \: \textrm{cm}$ into the above formula, we can solve for $r,$ as follows:
...
The height of a particular right cone is $\dfrac 43$ times the radius of its base. If the volume of the cone is $12 \pi \: \textrm{in}^3,$ what is the slant height of the cone?
...
Substituting $V = 12 \pi \: \textrm{in}^3$ and $h=\dfrac 43 r$ into the formula, we can solve for $r,$ as follows:
...
![Instructional graphic](../../../lesson-assets/sat-math-fundamentals/topic-1778/819c0e3597094d15.png)
