...
Source: https://www.mathacademy.com/topics/3753?courseId=120
Topic ID: 3753

## Prerequisites

- [Trend Lines](../../../high-school/traditional/lessons/algebra-i/2609-trend-lines.md)
...
![Instructional graphic](../../../lesson-assets/sat-math-fundamentals/topic-3753/1696d78bcd83a467.png)

First, we sketch the trend line. If we don't know the trend line's equation, then we simply approximate it.

![Instructional graphic](../../../lesson-assets/sat-math-fundamentals/topic-3753/c13aec3fd449cfcc.png)

To make our prediction, we proceed as follows:

- First, we start at $x = 5$ on the $x$-axis.

![Instructional graphic](../../../lesson-assets/sat-math-fundamentals/topic-3753/2a432e2480f73852.png)

- Then, we move up until we intersect the trend line.

![Instructional graphic](../../../lesson-assets/sat-math-fundamentals/topic-3753/55a4b40016d819b2.png)

- Finally, we move left until we intersect the $y$-axis.

![Instructional graphic](../../../lesson-assets/sat-math-fundamentals/topic-3753/a950e0e8322584f5.png)
...
![Instructional graphic](../../../lesson-assets/sat-math-fundamentals/topic-3753/5e458b16e42d805a.png)
...
![Instructional graphic](../../../lesson-assets/sat-math-fundamentals/topic-3753/d9b610fc4e93b138.png)

- Then, we move right until we intersect the trend line.

![Instructional graphic](../../../lesson-assets/sat-math-fundamentals/topic-3753/e434564bda8e4225.png)

- Finally, we move down until we intersect the horizontal axis.

![Instructional graphic](../../../lesson-assets/sat-math-fundamentals/topic-3753/afe754fb8f55eead.png)
...
![Instructional graphic](../../../lesson-assets/sat-math-fundamentals/topic-3753/de201ad628f75220.png)
...
![Instructional graphic](../../../lesson-assets/sat-math-fundamentals/topic-3753/b2461206bc5d0985.png)
...
![Instructional graphic](../../../lesson-assets/sat-math-fundamentals/topic-3753/b1dec8b216421aab.png)
...
![Instructional graphic](../../../lesson-assets/sat-math-fundamentals/topic-3753/766730ab6dbf3491.png)
...
![Instructional graphic](../../../lesson-assets/sat-math-fundamentals/topic-3753/7b3c4875b906335d.png)
...
![Instructional graphic](../../../lesson-assets/sat-math-fundamentals/topic-3753/ca450b280311877e.png)
