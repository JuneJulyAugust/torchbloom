...
Source: https://www.mathacademy.com/topics/354?courseId=120
Topic ID: 354

## Prerequisites

- [Solving Linear Equations With Unknown Coefficients by Factoring](../../../high-school/traditional/lessons/algebra-i/3752-solving-linear-equations-with-unknown-coefficients-by-factoring.md)
...
### Example: Solving Equations When the Variables are Separate
...
### Example: Solving Equations When the Variables are Multiplied
...
\begin{aligned}𝐸 & =𝑚𝐶 \\ \frac{𝐸}{𝐶} & =\frac{𝑚𝐶}{𝐶} \\ \frac{𝐸}{𝐶} & =𝑚\end{aligned}
...
**** This result assumes that $C\neq 0.$

### Example: Solving Equations Requiring Manipulation of Binomials
...
\begin{aligned}𝐸 & =𝑚𝐶+\frac{1}{2}𝑚𝑉 \\ 𝐸−𝑚𝐶 & =𝑚𝐶+\frac{1}{2}𝑚𝑉−𝑚𝐶 \\ 𝐸−𝑚𝐶 & =\frac{1}{2}𝑚𝑉\end{aligned}
...
\begin{aligned}𝐸−𝑚𝐶 & =\frac{1}{2}𝑚𝑉 \\ 2⋅(𝐸−𝑚𝐶) & =2⋅\frac{1}{2}𝑚𝑉 \\ 2(𝐸−𝑚𝐶) & =𝑚𝑉\end{aligned}
...
\begin{aligned}2(𝐸−𝑚𝐶) & =𝑚𝑉 \\ \frac{2(𝐸−𝑚𝐶)}{𝑚} & =\frac{𝑚𝑉}{𝑚} \\ \frac{2(𝐸−𝑚𝐶)}{𝑚} & =𝑉\end{aligned}
