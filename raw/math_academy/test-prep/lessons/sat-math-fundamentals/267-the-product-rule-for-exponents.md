...
Source: https://www.mathacademy.com/topics/267?courseId=120
Topic ID: 267
...
\begin{aligned}3^{4}×3^{2} & = \\ \underset{4 copies}{\underset{}{3×3×3×3}}×\underset{2 copies}{\underset{}{3×3}} & = \\ \underset{6 copies}{\underset{}{3×3×3×3×3×3}} & = \\ 3^{6} & \end{aligned}


$$

### Example: Applying the Power Rule for Exponents With Integer Bases
...
### Example: Evaluating Products with Negative Exponents Using the Product Rule
