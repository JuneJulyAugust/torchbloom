...
Source: https://www.mathacademy.com/topics/3116?courseId=24
Topic ID: 3116

## Prerequisites

- [Evaluating Expressions Using a Graphing Calculator](./1832-evaluating-expressions-using-a-graphing-calculator.md)
- [The Roots of a Function](../../../high-school/traditional/lessons/algebra-i/2022-the-roots-of-a-function.md)
...
![Instructional graphic](../../../lesson-assets/ap-calculus-ab/topic-3116/e71e842aab870499.png)
...
![Instructional graphic](../../../lesson-assets/ap-calculus-ab/topic-3116/9876663442a6ae14.png)
...
The calculator will now ask us to specify an interval containing the root and an initial guess. First, we select a "left bound," followed by a "right bound," followed by our "guess." To specify these values, we use the $\boxed{\color{gray}\,\blacktriangleleft\,}$ and $\boxed{\color{gray}\,\blacktriangleright\,}$ buttons to move the cursor along the curve, and press $\boxed{\color{gray}\,\text{enter}\,}$ to select.
...
![Instructional graphic](../../../lesson-assets/ap-calculus-ab/topic-3116/eb53c9512fb90432.png)
...
![Instructional graphic](../../../lesson-assets/ap-calculus-ab/topic-3116/3fb304c1ca4380e5.png)
...
![Instructional graphic](../../../lesson-assets/ap-calculus-ab/topic-3116/00cc46e1585d2850.png)
...
![Instructional graphic](../../../lesson-assets/ap-calculus-ab/topic-3116/ac2a6b061573ea08.png)
...
![Instructional graphic](../../../lesson-assets/ap-calculus-ab/topic-3116/63c1a2f427dbd950.png)
...
![Instructional graphic](../../../lesson-assets/ap-calculus-ab/topic-3116/dee875ea8ae4575a.png)
...
![Instructional graphic](../../../lesson-assets/ap-calculus-ab/topic-3116/9f1929404091f390.png)

By pressing the $\boxed{\color{gray}\text{window}}$ button, we see that this view is $x\in [-40,40], y\in [-40,40].$

Looking at the shape of the curve, it appears that the root will show up to the right of $x=40.$ So, let's adjust our window settings by selecting the following options under the $\boxed{\color{gray}\text{window}}$ menu.
...
![Instructional graphic](../../../lesson-assets/ap-calculus-ab/topic-3116/56f4c863799af9ff.png)
...
![Instructional graphic](../../../lesson-assets/ap-calculus-ab/topic-3116/eacbc6c89301f13a.png)

The positive root cannot be seen. However, if we zoom out twice, we get the following:

![Instructional graphic](../../../lesson-assets/ap-calculus-ab/topic-3116/1196e256c0dcdfd7.png)
...
![Instructional graphic](../../../lesson-assets/ap-calculus-ab/topic-3116/5fda40d155da276a.png)
...
![Instructional graphic](../../../lesson-assets/ap-calculus-ab/topic-3116/ab64f0d704974807.png)
...
![Instructional graphic](../../../lesson-assets/ap-calculus-ab/topic-3116/b25db018261d785e.png)
...
![Instructional graphic](../../../lesson-assets/ap-calculus-ab/topic-3116/e32ba0ffa61cc0b5.png)
...
![Instructional graphic](../../../lesson-assets/ap-calculus-ab/topic-3116/a4aa0091d5b1495f.png)
