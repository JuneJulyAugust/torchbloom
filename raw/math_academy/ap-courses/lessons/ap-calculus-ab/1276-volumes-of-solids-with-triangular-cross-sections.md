...
Source: https://www.mathacademy.com/topics/1276?courseId=24
Topic ID: 1276
...
![Instructional graphic](../../../lesson-assets/ap-calculus-ab/topic-1276/5883ed460b4189bb.png)

A sketch with a few cross-sections is shown in the picture below.

![Instructional graphic](../../../lesson-assets/ap-calculus-ab/topic-1276/ff0d40c4815d99b4.png)

Consider the picture with only one cross-section that passes through $x \in (0,3)\mathbin{:}$

![Instructional graphic](../../../lesson-assets/ap-calculus-ab/topic-1276/5ed773c7999d6621.png)

If we project the triangular cross-section onto the $xy$-plane, we get the picture below:

![Instructional graphic](../../../lesson-assets/ap-calculus-ab/topic-1276/693fcc6711e858b8.png)
...
![Instructional graphic](../../../lesson-assets/ap-calculus-ab/topic-1276/d71e30fd381811c8.png)

- For an equilateral triangle with side length $a$ (shown above), the area is given by the formula

![Instructional graphic](../../../lesson-assets/ap-calculus-ab/topic-1276/f7be45349fa5d3b0.png)
...
![Instructional graphic](../../../lesson-assets/ap-calculus-ab/topic-1276/1986d1aaefa2901e.png)

#### Explanation

Consider a cross-section at some point $x$, where $x \in (-3,-1),$ and its projection on the $xy$-plane:

![Instructional graphic](../../../lesson-assets/ap-calculus-ab/topic-1276/5862cb61fb96b170.png)
...
![Instructional graphic](../../../lesson-assets/ap-calculus-ab/topic-1276/4f4487e6507be4a8.png)
...
![Instructional graphic](../../../lesson-assets/ap-calculus-ab/topic-1276/ce8715d4a33aebdd.png)
...
![Instructional graphic](../../../lesson-assets/ap-calculus-ab/topic-1276/73cc31977e380fba.png)

A sketch with a few cross-sections is shown in the picture below.

![Instructional graphic](../../../lesson-assets/ap-calculus-ab/topic-1276/c52dabb029e9f2a4.png)

Consider the picture with only one cross-section that passes through $y \in (0,\sqrt{2})\mathbin{:}$

![Instructional graphic](../../../lesson-assets/ap-calculus-ab/topic-1276/e923fda6e7d52759.png)

If we project the triangular cross-section onto the $xy$-plane, we get the picture below:

![Instructional graphic](../../../lesson-assets/ap-calculus-ab/topic-1276/f00b6673a1326e00.png)
...
![Instructional graphic](../../../lesson-assets/ap-calculus-ab/topic-1276/f4c8ae678f169403.png)

#### Explanation

Consider a cross-section at some point $y$, where $y \in (0,\sqrt 2)$, and its projection on the $xy$-plane:

![Instructional graphic](../../../lesson-assets/ap-calculus-ab/topic-1276/17f1721066ba9808.png)
...
![Instructional graphic](../../../lesson-assets/ap-calculus-ab/topic-1276/32a72d8e24d57f21.png)
...
![Instructional graphic](../../../lesson-assets/ap-calculus-ab/topic-1276/9d57b82244aa90a9.png)
