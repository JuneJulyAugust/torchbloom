...
Source: https://www.mathacademy.com/topics/1280?courseId=21
Topic ID: 1280

## Prerequisites

- [Volumes of Solids with Square Cross Sections](../ap-calculus-ab/1083-volumes-of-solids-with-square-cross-sections.md)
- [Circles in the Coordinate Plane](../../../high-school/traditional/lessons/geometry/1183-circles-in-the-coordinate-plane.md)
...
![Instructional graphic](../../../lesson-assets/ap-calculus-bc/topic-1280/43eccc59e1cfb82f.png)

A sketch with a few cross-sections is shown in the picture below.

![Instructional graphic](../../../lesson-assets/ap-calculus-bc/topic-1280/dc02a564b9407160.png)

Consider a cross-section at some point $x$, where $x \in (0,1)$, and its projection onto the $xy$-plane:

![Instructional graphic](../../../lesson-assets/ap-calculus-bc/topic-1280/00ac20c500701d3d.png)

If we project the rectangular cross-section onto the $xy$-plane, we get the picture below:

![Instructional graphic](../../../lesson-assets/ap-calculus-bc/topic-1280/462695fb1b1ff616.png)
...
![Instructional graphic](../../../lesson-assets/ap-calculus-bc/topic-1280/45e97f3e5a02390a.png)

#### Explanation

Consider a cross-section at some point $x$, where $x \in \big(-\sqrt{2},\sqrt{2}\big)$, and its projection onto the $xy$-plane:

![Instructional graphic](../../../lesson-assets/ap-calculus-bc/topic-1280/fece1189162b0389.png)
...
![Instructional graphic](../../../lesson-assets/ap-calculus-bc/topic-1280/935e42ded81aac29.png)
...
![Instructional graphic](../../../lesson-assets/ap-calculus-bc/topic-1280/faf1d644b57465b0.png)
...
![Instructional graphic](../../../lesson-assets/ap-calculus-bc/topic-1280/918caf83a2ddefdb.png)

A sketch with a few cross-sections is shown in the picture below:

![Instructional graphic](../../../lesson-assets/ap-calculus-bc/topic-1280/74d1d71fa62e1574.png)

Now, consider the picture with only one cross-section that passes through some point $y \in (-2,0)\mathbin{:}$

![Instructional graphic](../../../lesson-assets/ap-calculus-bc/topic-1280/21fa7ac08ccaca5f.png)

The projection of the previous picture on the $xy$-plane is given below:

![Instructional graphic](../../../lesson-assets/ap-calculus-bc/topic-1280/ec7ef6cd22032183.png)
...
![Instructional graphic](../../../lesson-assets/ap-calculus-bc/topic-1280/a8630230bdb40f9f.png)

#### Explanation

Consider a cross-section at some point $y$, where $y \in (0,1)$, and its projection on the $xy$-plane:

![Instructional graphic](../../../lesson-assets/ap-calculus-bc/topic-1280/2634f96d2882f3f3.png)
...
![Instructional graphic](../../../lesson-assets/ap-calculus-bc/topic-1280/79246b22e3fa0fc5.png)
...
![Instructional graphic](../../../lesson-assets/ap-calculus-bc/topic-1280/2051af7058995f23.png)
