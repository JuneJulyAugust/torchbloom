...
Source: https://www.mathacademy.com/topics/616?courseId=21
Topic ID: 616

## Prerequisites

- [Simplifying Square Root Expressions Using Polynomial Factorization](../../../high-school/traditional/lessons/algebra-ii/448-simplifying-square-root-expressions-using-polynomial-factorization.md)
...
The horizontal asymptote of $y=f(x)$ is $y=\lim\limits_{x \rightarrow \infty} f(x).$ To evaluate the limit, note that the $x^4$ in the radical is a perfect square, so we can rewrite the function as
...
The horizontal asymptote of $f(x)$ in the domain $x< 0$ is $y=\lim\limits_{x \rightarrow -\infty} f(x).$ To find the horizontal asymptote, we note that the $x^6$ in the radical is a perfect square, and so we rewrite the function as
