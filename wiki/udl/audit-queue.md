...
id: udl-audit-queue
type: audit
title: UDL Audit Queue
chapter_scope: [ch01, ch02, ch03]
source_anchors:
  - source: udlbook-v5.0.3
    locator: raw/udl/textbook/index.md
confidence: directional
prerequisites: []
related: [udl-methodology, udl-schema]
learning_objectives:
  - Track OCR, source, and interpretation issues before pages are promoted beyond directional confidence.
---

# UDL Audit Queue

| Status | Scope | Issue | Source Anchor | Owner Notes |
| --- | --- | --- | --- | --- |
