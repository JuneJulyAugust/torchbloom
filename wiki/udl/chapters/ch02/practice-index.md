---
id: ch02-practice-index
type: practice-index
title: "Chapter 2 Practice Index"
chapter_scope: [ch02]
source_anchors:
...
prerequisites: [linear-regression, eq-2-5-least-squares-loss, slopes-and-gradients]
related: [ch02-reading-guide, notebook-2-1-supervised-learning]
learning_objectives:
  - Track every Chapter 2 problem and its answer policy.
---

# Chapter 2 Practice Index
...
Do 2.1 and 2.2 on paper first. Then do 2.3 with a tiny three-point dataset so
the difference between vertical and horizontal errors is visible.
