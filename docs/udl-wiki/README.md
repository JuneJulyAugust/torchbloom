...
This folder describes the private TorchBloom companion wiki for Simon Prince's
*Understanding Deep Learning*.

The wiki is not a Markdown copy of the book. It is an authored learning layer
that helps a high-school-math learner read UDL through source anchors, concept
bridges, equation pages, practice cards, and notebook guidance.
...
- `raw/udl/` stores source evidence and generated extracts.
